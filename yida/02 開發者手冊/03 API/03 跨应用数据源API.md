---
title: "跨应用数据源API"
source: "https://docs.aliwork.com/docs/developer/api/openAPI"
category: "開發者手冊 / API"
updated: 
tags:
  - yida
...
宜搭提供远程 API 调用的能力可以通过 HTTP 请求异步接口（详细使用请参考 [远程 API 文档](/docs/developer/guide/concept/datasource)），于此同时宜搭平台还提供了一些内置的远程 API 用于进行宜搭数据的操作。
...
![[dev-api-openAPI_O1CN01UOw5fH2AKK8cTHZDY_!!6000000008184-2-tps-3582-1230.png_.webp]]
...
| formData | 表单数据详情 | TPROC--EF6Y4G8WO2FN0SUB43TDQ3CGC3FMFQ1G9400RCJ4 | 参考[附录 4-
