---
title: "表单校验"
source: "https://docs.aliwork.com/docs/developer/guide/concept/validation"
...
![[dev-guide-concept-validation_O1CN01EwO6P121YDcIbIEKd_!!6000000006996-2-tps-2664-1166.png_.webp]]
...
![[dev-guide-concept-validation_O1CN01J2hlva1VJVBbzqUk9_!!6000000002632-2-tps-3582-2016.png_.webp]]
...
functionvalidateRule(value:any):boolean;
```
...
表单校验除了在表单提交的时候进行校验，还能够通过[前端API](/docs/developer/api/yidaAPI#thisfieldidvalidate)进行手动触发，如下所示：
