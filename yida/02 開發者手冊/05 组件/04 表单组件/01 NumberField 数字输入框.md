...
source: "https://docs.aliwork.com/docs/developer/components/form/numberField"
...
placeholder
 ...
 | 表单组件占位提示信息 | string | '请输入数字' |
|

precision

 | 小数点位数，取值范围在0 - 20 | number | 0 |
|
