...
source: "https://docs.aliwork.com/docs/developer/components/form/attachmentField"
...
accept
 ...
 | 设置上传文件类型(多个以英文逗号，分隔)，如 .doc, .docx, .pdf | string |
...
buttonSize
 ...
 | 设置按钮尺寸 | 'small' | 'medium' | 'large' | 'medium' |
|
...
buttonType
 ...
 | 设置按钮类型 | 'primary' | 'secondary' | 'normal' | 'primary' |
|
...
data
 ...
 | 设置上传可附带的额外参数 | Record<string, string> | {} |
|
...
headers
 ...
 | 设置上传的请求头部 | Record<string, string> | {} |
|
...
type
 ...
 | 设置上传类型，仅 PC 端有效 | 'normal' | 'drag' | 'normal' |
|
