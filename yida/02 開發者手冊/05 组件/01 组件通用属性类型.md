---
title: "组件通用属性类型"
source: "https://docs.aliwork.com/docs/developer/components/interface"
category: "開發者手冊 / 组件"
updated: 
tags:
  - yida
  - 開發者手冊
---
本文档主要列举宜搭组件用到的通用属性的类型说明，用户可以在动作面板中通过以下API来的读取或者设置组件的指定属性（具体详见[组件通用API](/docs/developer/api/yidaAPI#%E7%BB%84%E4%BB%B6%E9%80%9A%E7%94%A8-api)）：

```javascript
// 获取组件的属性值
exportfunction getAttribute(){
...
interface TableColumn {
  ...
  render?: (value: any, index: number, rowData: any) => ReactNode; // 内容定制渲染
