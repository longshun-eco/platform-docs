...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-open-chat-by-chat-id_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-open-chat-by-chat-id_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| chatId | String | 是 | 32222 | 群会话chatId。 |
| corpId | String | 否 | ding\*\* | 企业corpId。  在H5应用中必填。 |
