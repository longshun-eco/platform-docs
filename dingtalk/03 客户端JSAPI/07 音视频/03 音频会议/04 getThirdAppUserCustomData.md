...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-get-third-app-user-custom-data_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-get-third-app-user-custom-data_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
1. 会议扩展应用是指，企业可以在开发者后台开发H5或小程序酷应用，用户可以在会议设置面板中点击使用此酷应用，例如用下面的例子：
   ...
   ![[development-jsapi-get-third-app-user-custom-data_O1CN011RjpGX1RUGFziRqmr_!!6000000002114-2-tps-541-539.png]]
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| thirdAppId | String | 是 | 2818774410 | 会议扩展应用的appId，从开发者后台对应的微应用基础信息页面获取：   * 企业自建应用为原企业内部应用AgentId * 第三方企业应用为原三方企业应用AppId。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| userCustomData | String | Q09PTEFQUC0wLTEwMjcxMTdENkRDNjIxMzY3N0E5MDAwWA | 用户的业务自定义信息 |
