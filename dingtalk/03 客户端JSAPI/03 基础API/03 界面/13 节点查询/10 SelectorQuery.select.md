...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-selector-query-select_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-selector-query-select_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| selector | String | 是 | .all | 选择当前第一个匹配选择器的节点，选择器支持 id 选择器以及 class 选择器。 |
