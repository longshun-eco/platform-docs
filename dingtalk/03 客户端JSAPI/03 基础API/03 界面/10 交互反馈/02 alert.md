...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-alert_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-alert_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| title | String | 是 | 消息提示 | alert框的标题。 |
| content | String | 是 | 请求发布成功 | alert框的内容。 |
| buttonText | String | 否 | 我知道了 | 按钮文字。 |
