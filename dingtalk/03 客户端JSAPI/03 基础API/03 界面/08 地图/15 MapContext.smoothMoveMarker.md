...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-map-context-smooth-move-marker_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-map-context-smooth-move-marker_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| markerId | Number | 是 | 0 | 执行动画的 markerId，确保此时 marker 已经在地图上。 |
...
| duration | Number | 否 | 5000 | 动画执行时间。 默认值： 5000 毫秒（ms）。 |
| targetDistances | Array<Number> | 否 | [100,200,300,600] | 指定需要 callback 的目标距离数组。 |
