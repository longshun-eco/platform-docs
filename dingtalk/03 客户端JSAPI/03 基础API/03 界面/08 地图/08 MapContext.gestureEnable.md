...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-map-context-gesture-enable_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-map-context-gesture-enable_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| isGestureEnable | Number | 是 | 1 | 指定手势是否可用。   * 1：表示可用 * 0：表述不可用 |
