...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-canvas-context-set-shadow_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-canvas-context-set-shadow_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| offsetX | Number | 否 | 0 | 阴影相对于形状水平方向的偏移。 |
| offsetY | Number | 否 | 0 | 阴影相对于形状竖直方向的偏移。 |
| blur | Number | 否 | 0 | 阴影的模糊级别，值越大越模糊，范围 0~100。 |
| color | String | 否 | #ffffff | 阴影颜色。 |
