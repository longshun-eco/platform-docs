...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-canvas-context-rect_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-canvas-context-rect_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| x | String | 是 | 0 | 矩形左上角的 x 坐标。 |
| y | String | 是 | 0 | 矩形左上角的 y 坐标。 |
| width | String | 是 | 10 | 矩形路径宽度。 |
| height | String | 是 | 20 | 矩形路径高度。 |
