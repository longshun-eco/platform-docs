...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-get-network-type_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-get-network-type_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| networkAvailable | Boolean | true | 网络是否可用。 |
| networkType | String | WIFI | 网络类型值，**UNKNOWN / NOTREACHABLE / WIFI / 3G / 2G / 4G / WWAN**。  桌面端不支持该字。 |
