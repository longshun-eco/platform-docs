...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-on-ble-characteristic-value-change_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-on-ble-characteristic-value-change_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| deviceId | String | 0D9C82AD-1CC0-414D-9526-119E08D28124 | 蓝牙设备 id，参考 device 对象。 |
| serviceId | String | 00001800-0000-1000-8000-00805f9b34fb | 蓝牙特征值对应 service 的 uuid。 |
| characteristicId | String | 9fa480e0-4967-4542-9390-d343dc5d04ae | 蓝牙特征值的 uuid。 |
| value | String | 0x26FF | 特征值最新的16进制值。 |
