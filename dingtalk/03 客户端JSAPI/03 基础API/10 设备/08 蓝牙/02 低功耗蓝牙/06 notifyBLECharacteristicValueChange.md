...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-notify-ble-haracteristic-value-change_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-notify-ble-haracteristic-value-change_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| state | Boolean | 否 | true | 是否启用notify或indicate。 |
| deviceId | String | 是 | 0D9C82AD-1CC0-414D-9526-119E08D28124 | 蓝牙设备 id，参考 device 对象。 |
...
| descriptorId | String | 否 | 00002902-0000-10008000-00805f9b34fb | notify 的 descriptor 的 uuid。  只有android 会用到，非必填，默认值00002902-0000-10008000-00805f9b34fb。 |
