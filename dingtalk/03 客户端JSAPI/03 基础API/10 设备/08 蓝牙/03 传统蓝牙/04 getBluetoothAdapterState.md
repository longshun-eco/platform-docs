...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-get-bluetooth-adapter-state_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-get-bluetooth-adapter-state_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| available | Boolean | true | 蓝牙模块是否可用。  需支持 BLE 并且蓝牙是打开状态。 |
| discovering | Boolean | true | 是否正在搜索设备。 |
