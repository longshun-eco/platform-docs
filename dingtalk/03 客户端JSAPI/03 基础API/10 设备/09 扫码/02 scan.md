...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-scan_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-scan_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| type | String | 否 | qr | 扫码框 UI 样式，默认值： `qr`   * `qr`：二维码扫码框 * `bar`：条形码扫码框 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| text | String | 我是躲在二维码背后的数据 | 扫码所得数据。 |
