...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-get-auth-code_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-get-auth-code_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| corpId | String | 是 | ding12345xxx | 企业 CorpID。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| authCode | String | hYLK98jkf0m | 授权码。有效期5分钟，且只能使用一次，使用后会失效。 |
