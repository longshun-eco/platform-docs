...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-file-system-manager-readdir_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-file-system-manager-readdir_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| dirPath | String | 是 | ${dd.env.USER\_DATA\_PATH}/newDir | 本地用户文件目录，调用创建本地用户目录接口获取。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| files | Array<String> | ['https://resource/43fbb13460c2c917ef7d0370d9bf09f0.file'] | 本地用户目录下的文件或目录列表。 |
| success | Boolean | true | 成功获取本地用户文件和目录列表时，返回true。 |
