...
tags:
  ...
  - 客户端JSAPI
---
![[development-jsapi-file-system-manager-access_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-jsapi-file-system-manager-access_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| path | String | 是 | ${dd.env.USER\_DATA\_PATH}/newDir | 文件夹路径或者文件路径。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| success | Boolean | true | 文件或目录存在时，返回true。 |
