...
tags:
  ...
  - 服务端API
---
![[development-terminate-a-process-instance_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-terminate-a-process-instance_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-23调用本接口终止流程实例。

![[development-terminate-a-process-instance_O1CN01SEnwOh20MwEngSRCo_!!6000000006836-2-tps-950-534.png]]
...
| 企业内部应用 | 支持 | 宜搭流程数据写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23TerminateInstance) |
| 第三方企业应用 | 支持 | 宜搭流程数据写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23TerminateInstance) |
| 第三方个人应用 | 暂不支持 | 宜搭流程数据写权限 | 暂不支持 |

## 请求方法

```
PUT /v1.0/yida/processes/instances/terminate?appType=String&systemToken=String&userId=String&language=String&processInstanceId=String HTTP/1.1
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| appType | String | 是 | 应用ID。 ![[development-terminate-a-process-instance_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| systemToken | String | 是 | 应用密钥。 ![[development-terminate-a-process-instance_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
| userId | String | 是 | 用户的userid。 |
| language | String | 否 | 语言，取值：   * zh\_CN：中文（默认值） * en\_US：英文 |
| processInstanceId | String | 是 | 流程实例ID，可通过调用[发起宜搭审批流程](/document/development/api-startinstance-v2)接口获取。 |
