...
tags:
  ...
  - 服务端API
---
![[development-delete-the-process-instance_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-delete-the-process-instance_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-12-08调用本接口删除流程实例。

![[development-delete-the-process-instance_O1CN0146huuf1iNhoWQxDhX_!!6000000004401-2-tps-1024-562.png]]
...
| 企业内部应用 | 支持 | 宜搭流程数据写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23DeleteInstance) |
| 第三方企业应用 | 支持 | 宜搭流程数据写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23DeleteInstance) |
| 第三方个人应用 | 暂不支持 | 宜搭流程数据写权限 | 暂不支持 |

## 请求方法

```sql
DELETE /v1.0/yida/processes/instances?appType=String&systemToken=String&userId=String&language=String&processInstanceId=String HTTP/1.1
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| appType | String | 是 | 应用标识。 ![[development-delete-the-process-instance_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| systemToken | String | 是 | 应用密钥，在应用数据中获取。 ![[development-delete-the-process-instance_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
