...
tags:
  ...
  - 服务端API
---
![[development-api-getinstanceidlist-v2_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-getinstanceidlist-v2_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口获取实例ID列表。

![[development-api-getinstanceidlist-v2_O1CN010N2LDi1cEBtZLdKCY_!!6000000003568-2-tps-1008-512.png]]
...
| 企业内部应用 | 支持 | 宜搭流程数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_2.0%23GetInstanceIdList) |
| 第三方企业应用 | 支持 | 宜搭流程数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_2.0%23GetInstanceIdList) |
| 第三方个人应用 | 暂不支持 | 宜搭流程数据读权限 | 暂不支持 |

## 请求方法

```
POST /v2.0/yida/processes/instanceIds?pageSize=Integer&pageNumber=Integer HTTP/1.1
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| formUuid | String | 是 | 表单ID。 ![[development-api-getinstanceidlist-v2_O1CN01HdY3Dp1PuFLl6yIFS_!!6000000001900-2-tps-2688-1160.png]] |
| modifiedToTimeGMT | String | 否 | 修改时间终止值。 |
| systemToken | String | 是 | 应用密钥。 ![[development-api-getinstanceidlist-v2_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
...
| appType | String | 是 | 应用编码。 ![[development-api-getinstanceidlist-v2_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
