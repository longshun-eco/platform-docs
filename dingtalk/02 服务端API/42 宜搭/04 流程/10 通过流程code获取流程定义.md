...
tags:
  ...
  - 服务端API
---
![[development-obtain-definition-through-process-code_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtain-definition-through-process-code_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2026-03-17调用本接口，通过 processCode 获取流程定义。
...
| 企业内部应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23GetProcessDesignByCode) |
| 第三方企业应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23GetProcessDesignByCode) |
| 第三方个人应用 | 暂不支持 | 暂不支持 | 暂不支持 |

## 请求方法

```
GET /v1.0/yida/processes/designStructures?systemToken=String&userId=String&appType=String&processId=Long&processCode=String HTTP/1.1
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| systemToken | String | 是 | 应用密钥。在应用数据中获取。 ![[development-obtain-definition-through-process-code_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
| userId | String | 是 | 钉钉userId。 |
| appType | String | 是 | 应用编码。 ![[development-obtain-definition-through-process-code_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| processId | Long | 否 | 流程id。 |
| processCode | String | 是 | 流程编码。 ![[development-obtain-definition-through-process-code_O1CN01wfayc31oU13xpzPfX_!!6000000005227-2-tps-2704-1152.png]] |
