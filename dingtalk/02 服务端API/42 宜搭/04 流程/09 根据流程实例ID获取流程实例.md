...
tags:
  ...
  - 服务端API
---
![[development-api-getinstancebyid-v2_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-getinstancebyid-v2_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口根据指定流程实例ID获取流程实例详情。

![[development-api-getinstancebyid-v2_O1CN01iD7VIq1GPFuer8bui_!!6000000000614-2-tps-1012-302.png]]
...
| 企业内部应用 | 支持 | 宜搭流程数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_2.0%23GetInstanceById) |
| 第三方企业应用 | 支持 | 宜搭流程数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_2.0%23GetInstanceById) |
| 第三方个人应用 | 暂不支持 | 宜搭流程数据读权限 | 暂不支持 |

## 请求方法

```
GET /v2.0/yida/processes/instancesInfos/{id}?appType=String&systemToken=String&userId=String&language=String&useAlias=Boolean&formUuid=String HTTP/1.1
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| appType | String | 是 | 应用ID。 ![[development-api-getinstancebyid-v2_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| systemToken | String | 是 | 应用密钥，在应用数据中获取。 ![[development-api-getinstancebyid-v2_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
