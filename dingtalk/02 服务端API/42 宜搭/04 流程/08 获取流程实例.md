...
tags:
  ...
  - 服务端API
---
![[development-api-getinstances-v2_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-getinstances-v2_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-23用于获取宜搭的流程实例信息，包括实例Id、创建时间、发起人等信息。

例如，企业宜搭应用内的流程列表如下截图，调用本接口获取流程实例的详情信息。

![[development-api-getinstances-v2_O1CN01nH6sKI1KANVwd40t6_!!6000000001123-2-tps-950-466.png]]
...
| 企业内部应用 | 支持 | 宜搭流程数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_2.0%23GetInstances) |
| 第三方企业应用 | 支持 | 宜搭流程数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_2.0%23GetInstances) |
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| appType | String | 是 | 应用ID。 ![[development-api-getinstances-v2_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| systemToken | String | 是 | 应用密钥。 ![[development-api-getinstances-v2_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
| userId | String | 是 | 用户的userid。 |
| language | String | 否 | 语言，取值：   * zh\_CN：中文（默认值） * en\_US：英文 |
| formUuid | String | 是 | 表单ID。 ![[development-api-getinstances-v2_O1CN01HdY3Dp1PuFLl6yIFS_!!6000000001900-2-tps-2688-1160.png]] |
