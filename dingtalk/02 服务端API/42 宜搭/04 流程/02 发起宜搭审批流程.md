...
tags:
  ...
  - 服务端API
---
![[development-api-startinstance-v2_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-startinstance-v2_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口发起宜搭审批流程到钉钉开放平台。

![[development-api-startinstance-v2_O1CN01rLyTMf1NUTk9O6HZd_!!6000000001573-2-tps-960-288.png]]
...
| 企业内部应用 | 支持 | 宜搭流程数据写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_2.0%23StartInstance) |
| 第三方企业应用 | 支持 | 宜搭流程数据写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_2.0%23StartInstance) |
| 第三方个人应用 | 暂不支持 | 宜搭流程数据写权限 | 暂不支持 |
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| appType | String | 是 | 应用编码。 ![[development-api-startinstance-v2_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| systemToken | String | 是 | 应用密钥。在应用数据中获取。 ![[development-api-startinstance-v2_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
| userId | String | 是 | 用户的userid。 |
| language | String | 否 | 语言，取值：   * **zh\_CN**：中文（默认值） * **en\_US**：英文 |
| formUuid | String | 是 | 表单唯一编码。 ![[development-api-startinstance-v2_O1CN01HdY3Dp1PuFLl6yIFS_!!6000000001900-2-tps-2688-1160.png]] |
| formDataJson | String | 是 | 表单数据，示例： `"{\"textField_jcpm6agt\": \"单行\",\"employeeField_jcos0sar\": [\"workno\"]}"`   * key：流程组件标识，宜搭表单编辑页面，高级设置中查看。 * value：流程组件内的值。 ![[development-api-startinstance-v2_O1CN01yTqqI51eViHNpsmb2_!!6000000003877-2-tps-2662-1014.png]] |
| processCode | String | 否 | 流程编码。 ![[development-api-startinstance-v2_O1CN01wfayc31oU13xpzPfX_!!6000000005227-2-tps-2704-1152.png]] |
