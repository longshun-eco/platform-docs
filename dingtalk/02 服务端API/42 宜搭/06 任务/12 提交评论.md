...
tags:
  ...
  - 服务端API
---
![[development-submit-comment_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-submit-comment_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口提交表单或流程实例下的评论。

![[development-submit-comment_O1CN01HVPXgL1YDxE4C6Bwd_!!6000000003026-2-tps-1002-522.png]]
...
| 企业内部应用 | 支持 | 宜搭评论写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23SaveFormRemark) |
| 第三方企业应用 | 支持 | 宜搭评论写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23SaveFormRemark) |
| 第三方个人应用 | 暂不支持 | 宜搭评论写权限 | 暂不支持 |
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| appType | String | 是 | 应用ID。 ![[development-submit-comment_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| systemToken | String | 是 | 应用秘钥。 ![[development-submit-comment_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
...

{
  ...
  "replyId" : 12,
  "language" : "zh_CN",
  "formInstanceId" : "33f6d221-17f8-42b7-836a-682b95a046c2",
  "userId" : "未知",
  "atUserId" : "多个工号,用英文逗号分隔",
  "content" : "未知"
}
```
