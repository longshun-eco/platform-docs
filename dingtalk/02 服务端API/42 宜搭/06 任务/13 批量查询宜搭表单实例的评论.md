...
tags:
  ...
  - 服务端API
---
![[development-batch-query-of-comments-appropriate-for-form-instances_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-batch-query-of-comments-appropriate-for-form-instances_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09批量查询宜搭表单下的所有评论。

例如，宜搭表单实例页面下方的评论信息如下图所示。调用本接口可获取全部评论的详情信息。

![[development-batch-query-of-comments-appropriate-for-form-instances_O1CN01McNje51CdfwXdNXDe_!!6000000000104-2-tps-2406-1480.png]]
...
| 企业内部应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23ListFormRemarks) |
| 第三方企业应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23ListFormRemarks) |
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| formUuid | String | 是 | 表单编码。  **说明**  该参数从宜搭应用中获取。 ![[development-batch-query-of-comments-appropriate-for-form-instances_O1CN014jJvg71N1coSRWA6l_!!6000000001510-2-tps-2384-866.png]] |
| appType | String | 是 | 宜搭应用编码。  **说明**  该参数从宜搭应用中获取。 ![[development-batch-query-of-comments-appropriate-for-form-instances_O1CN01fVFzAL1dFOZX3z8hV_!!6000000003706-2-tps-2390-854.png]] |
| systemToken | String | 是 | 宜搭应用密钥。  **说明**  该参数从宜搭应用中获取。 ![[development-batch-query-of-comments-appropriate-for-form-instances_O1CN01dFq4Vj1Ti7FZf0zNz_!!6000000002415-2-tps-2382-862.png]] |
| formInstanceIdList | Array of String | 否 | 宜搭表单实例Id，调用[获取实例ID列表](/document/development/api-getinstanceidlist-v2)接口或者[获取多个表单实例ID](/document/development/api-searchformdataidlist-v2)接口获取。 |
...
| --- | --- | --- |
| 名称 | 类型 | 描述 |
| formRemarkVoMap | Map | 获取的结果详情。Map格式，key值为当前宜搭表单实例的Id，value值为某个评论的详情信息。  **说明**  value内表示评论的详情信息，有以下字段：   * images：如果提交评论时上传了图片，该字段表示图片的信息，包含图片格式和名称等信息。 * creator：当前评论提交人的userId。 * formInstId：当前宜搭表单实例Id。 * files：如果提交评论时上传了文件，该字段表示文件的信息，包含文件格式和名称等信息。 * id：当前评论的标识。 * gmtCreate：评论提交的时间。 * content：评论的文本内容。 |
...

{
  "FINST-GW866Dxxxx" : [ {
    "creator" : "manager9358",
    "images" : "[]",
    "formInstId" : "FINST-GW866DA1NZVP1L0",
    "files" : "[]",
    "id" : 3261500001,
  ...
  "FINST-966MxxxXM" : [ {
    "creator" : "manager9358",
    "images" : "[]",
    "formInstId" : "FINST-96766PB1LBZYTVGI52J857AFKWWR3MX3CS41LXM6",
    "files" : "[]",
    "id" : 3261500003,
