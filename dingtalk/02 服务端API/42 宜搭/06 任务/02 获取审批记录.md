...
tags:
  ...
  - 服务端API
---
![[development-queries-an-approval-record_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-queries-an-approval-record_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-12-11调用本接口获取审批记录。

![[development-queries-an-approval-record_O1CN01Bh2OJ61iID41gzslI_!!6000000004389-2-tps-1016-346.png]]
...
| --- | --- | --- | --- |
| 企业内部应用 | 支持 | 宜搭流程数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23GetOperationRecords) |
| 第三方企业应用 | 支持 | 宜搭流程数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23GetOperationRecords) |
| 第三方个人应用 | 暂不支持 | 宜搭流程数据读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/yida/processes/operationRecords?appType=String&systemToken=String&userId=String&language=String&processInstanceId=String HTTP/1.1
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| appType | String | 是 | 应用ID。 ![[development-queries-an-approval-record_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| systemToken | String | 是 | 应用秘钥。 ![[development-queries-an-approval-record_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
| userId | String | 是 | 用户的userid。 |
| language | String | 否 | 语言，取值：   * zh\_CN：中文（默认值） * en\_US：英文 |
| processInstanceId | String | 是 | 流程实例ID。   * 企业内部应用，调用[获取多个表单实例ID](https://open.dingtalk.com/document/orgapp/obtain-the-ids-of-multiple-form-instances)接口获取。 * 第三方企业应用，调用[获取多个表单实例ID](https://open.dingtalk.com/document/isvapp/obtain-the-ids-of-multiple-form-instances)接口获取。 |
