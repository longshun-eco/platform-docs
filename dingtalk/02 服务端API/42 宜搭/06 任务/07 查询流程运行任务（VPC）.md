...
tags:
  ...
  - 服务端API
---
![[development-query-process-running-tasks-vpc_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-query-process-running-tasks-vpc_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口查询流程运行任务（VPC）。
...
| 企业内部应用 | 支持 | 宜搭任务读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23GetRunningTasks) |
| 第三方企业应用 | 支持 | 宜搭任务读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23GetRunningTasks) |
| 第三方个人应用 | 暂不支持 | 宜搭任务读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/yida/processes/tasks/getRunningTasks?processInstanceId=String&appType=String&systemToken=String&language=String&userId=String HTTP/1.1
...
| appType | String | 否 | 应用ID。 ![[development-query-process-running-tasks-vpc_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| systemToken | String | 否 | 应用秘钥，在应用数据中获取。 ![[development-query-process-running-tasks-vpc_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
