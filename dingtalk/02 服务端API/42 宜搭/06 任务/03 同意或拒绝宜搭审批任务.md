...
tags:
  ...
  - 服务端API
---
![[development-execute-approval-tasks_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-execute-approval-tasks_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09本接口用于同意或拒绝宜搭审批任务。

![[development-execute-approval-tasks_O1CN01nytRtU1yP6t5vfebu_!!6000000006570-2-tps-2550-1430.png]]
...
| 企业内部应用 | 支持 | 宜搭流程数据写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23ExecuteTask) |
| 第三方企业应用 | 支持 | 宜搭流程数据写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23ExecuteTask) |
...
| appType | String | 是 | 应用ID。 ![[development-execute-approval-tasks_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| formDataJson | String | 否 | 更新的表单值。 |
| systemToken | String | 是 | 应用秘钥。 ![[development-execute-approval-tasks_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
| language | String | 否 | 语言，取值：   * zh\_CN：中文（默认值） * en\_US：英文 |
| remark | String | 是 | 审批意见。 |
| processInstanceId | String | 是 | 实例ID，调用[获取多个表单实例ID](/document/development/api-searchformdataidlist-v2)接口获取。 |
| userId | String | 是 | 用户的userid。 |
| taskId | Long | 是 | 任务ID。 |
| digitalSignUrl | String | 否 | 电子签名地址。 审批人生成过电子签名后，可在签名展示页的接口返回值中查询到电子签名的url。 ![[development-execute-approval-tasks_O1CN01F2OiBu1uptaV5E82H_!!6000000006087-2-tps-3558-1908.png]] |
