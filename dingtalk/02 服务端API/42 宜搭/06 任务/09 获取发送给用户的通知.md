...
tags:
  ...
  - 服务端API
---
![[development-get-notifications-sent-to-users_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-get-notifications-sent-to-users_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口获取发送给用户的通知。

![[development-get-notifications-sent-to-users_O1CN018p18zT208jxXVoCkf_!!6000000006805-2-tps-1004-996.png]]
...
| 企业内部应用 | 支持 | 宜搭任务读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23GetNotifyMe) |
| 第三方企业应用 | 支持 | 宜搭任务读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23GetNotifyMe) |
| 第三方个人应用 | 暂不支持 | 宜搭任务读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/yida/corpNotifications/{userId}?corpId=String&token=String&pageNumber=Integer&pageSize=Integer&language=String&keyword=String&appTypes=String&processCodes=String&instanceCreateFromTimeGMT=Long&instanceCreateToTimeGMT=Long&createFromTimeGMT=Long&createToTimeGMT=Long HTTP/1.1
...
| appTypes | String | 否 | 应用标识列表。 ![[development-get-notifications-sent-to-users_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| processCodes | String | 否 | 流程code列表。 ![[development-get-notifications-sent-to-users_O1CN01HdY3Dp1PuFLl6yIFS_!!6000000001900-2-tps-2688-1160.png]] |
