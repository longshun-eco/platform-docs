...
tags:
  ...
  - 服务端API
---
![[development-query-tasks-from-the-organization-dimension_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-query-tasks-from-the-organization-dimension_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口获取组织维度任务列表。
...
| 企业内部应用 | 支持 | 宜搭任务读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23GetCorpTasks) |
| 第三方企业应用 | 支持 | 宜搭任务读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23GetCorpTasks) |
| 第三方个人应用 | 暂不支持 | 宜搭任务读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/yida/corpTasks?corpId=String&pageSize=Integer&language=String&pageNumber=Integer&keyword=String&appTypes=String&processCodes=String&createFromTimeGMT=Long&createToTimeGMT=Long&userId=String&token=String HTTP/1.1
...
| appTypes | String | 否 | 应用标识列表。 ![[development-query-tasks-from-the-organization-dimension_O1CN0143ZipQ1mKHWRj0B1o_!!6000000004935-2-tps-1153-520.png]] |
| processCodes | String | 否 | 流程code列表。 ![[development-query-tasks-from-the-organization-dimension_O1CN013aot5b1aKwhtJhDA5_!!6000000003312-2-tps-1153-558.png]] |
