...
tags:
  ...
  - 服务端API
---
![[development-query-copied-my-task-list-application-dimension_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-query-copied-my-task-list-application-dimension_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口查询抄送我的任务列表（应用维度）。
...
| 企业内部应用 | 支持 | 宜搭任务读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23GetTaskCopies) |
| 第三方企业应用 | 支持 | 宜搭任务读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23GetTaskCopies) |
| 第三方个人应用 | 暂不支持 | 宜搭任务读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/yida/tasks/taskCopies?appType=String&systemToken=String&pageSize=Integer&language=String&pageNumber=Integer&keyword=String&userId=String&processCodes=String&createFromTimeGMT=Long&createToTimeGMT=Long HTTP/1.1
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| appType | String | 是 | 应用ID。 ![[development-query-copied-my-task-list-application-dimension_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| systemToken | String | 是 | 应用秘钥，在应用数据中获取。 ![[development-query-copied-my-task-list-application-dimension_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
...
| processCodes | String | 否 | 流程code列表。 ![[development-query-copied-my-task-list-application-dimension_O1CN01HdY3Dp1PuFLl6yIFS_!!6000000001900-2-tps-2688-1160.png]] |
