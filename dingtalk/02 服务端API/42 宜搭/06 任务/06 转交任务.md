...
tags:
  ...
  - 服务端API
---
![[development-transfer-tasks_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-transfer-tasks_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口转交任务。
...
| 企业内部应用 | 支持 | 宜搭任务写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23RedirectTask) |
| 第三方企业应用 | 支持 | 宜搭任务写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23RedirectTask) |
...
| appType | String | 是 | 应用ID。 ![[development-transfer-tasks_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| systemToken | String | 是 | 应用秘钥，在应用数据中获取。 ![[development-transfer-tasks_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
