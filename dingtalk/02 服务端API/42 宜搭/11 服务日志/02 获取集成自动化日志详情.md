...
tags:
  ...
  - 服务端API
---
![[development-api-getautoflowlogdetail_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-getautoflowlogdetail_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09通过集成自动化的实例 id 获取日志详情信息。
...
| 企业内部应用 | 支持 | 宜搭应用数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23GetAutoFlowLogDetail) |
| 第三方企业应用 | 支持 | 宜搭应用数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23GetAutoFlowLogDetail) |
| 第三方个人应用 | 暂不支持 | 暂不支持 | 暂不支持 |

## 请求方法

```
GET /v1.0/yida/logs/automations?pageSize=Integer&userId=String&procInstanceId=String&pageNumber=Integer&token=String&corpId=String HTTP/1.1
...
| procInstanceId | String | 是 | 通过调用[分页获取集成自动化日志列表](/document/development/api-pageautoflowlog)接口获取实例 id。 |
| pageNumber | Integer | 是 | 当前第几页，大于等于1。 |
| token | String | 是 | corpId+userId+CorpToken做md5加密计算生成的字符串，每个企业有自己的唯一corpToken，可以在平台设置-基本信息中查看。 ![[development-api-getautoflowlogdetail_O1CN01N5cblG1EWT7e4Q1hO_!!6000000000359-2-tps-2560-1440.png]] |
