...
tags:
  ...
  - 服务端API
---
![[development-api-pageautoflowlog_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-pageautoflowlog_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口，根据表单信息数据，获取集成自动化日志列表。
...
| 企业内部应用 | 支持 | 宜搭应用数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23PageAutoFlowLog) |
| 第三方企业应用 | 支持 | 宜搭应用数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23PageAutoFlowLog) |
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| formUuid | String | 否 | 表单页面编码，可以在应用设置-部署运维中获取。 ![[development-api-pageautoflowlog_O1CN01HdY3Dp1PuFLl6yIFS_!!6000000001900-2-tps-2688-1160.png]] |
| pageNumber | Integer | 是 | 当前第几页，大于等于1。 |
| corpId | String | 是 | 钉钉组织 corpId。 |
| startTimeGMT | Long | 否 | 开始时间，格式为时间戳 |
| appType | String | 否 | 宜搭应用编码，可以在应用设置-部署运维中获取。 ![[development-api-pageautoflowlog_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| processCode | String | 否 | 流程编码，可以在集成自动化详情页的链接中获取。 ![[development-api-pageautoflowlog_O1CN01wfayc31oU13xpzPfX_!!6000000005227-2-tps-2704-1152.png]] |
| endTimeGMT | Long | 否 | 结束时间，格式为时间戳，单位毫秒。 |
| pageSize | Integer | 是 | 分页大小，最大值为100。 |
| userId | String | 是 | 钉钉userId。 |
| token | String | 是 | corpId+userId+CorpToken做md5加密计算生成的字符串，每个企业有自己的唯一corpToken，可以在平台设置-基本信息中查看。 ![[development-api-pageautoflowlog_O1CN01N5cblG1EWT7e4Q1hO_!!6000000000359-2-tps-2560-1440.png]] |
