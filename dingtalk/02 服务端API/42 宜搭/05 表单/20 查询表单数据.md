...
tags:
  ...
  - 服务端API
---
![[development-api-getformdatabyid-v2_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-getformdatabyid-v2_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-23调用本接口通过表单实例ID查询表单数据。

![[development-api-getformdatabyid-v2_O1CN01EFCwje1jSZdi7rLtu_!!6000000004547-2-tps-930-434.png]]
...
| 企业内部应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_2.0%23GetFormDataByID) |
| 第三方企业应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_2.0%23GetFormDataByID) |
| 第三方个人应用 | 暂不支持 | 宜搭表单数据读权限 | 暂不支持 |

## 请求方法

```
GET /v2.0/yida/forms/instances/{id}?appType=String&systemToken=String&userId=String&language=String&useAlias=Boolean&formUuid=String HTTP/1.1
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| id | String | 否 | 表单实例ID，通过[获取多个表单实例ID](/document/development/api-searchformdataidlist-v2)接口获取。 |
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| appType | String | 否 | 应用编码。 ![[development-api-getformdatabyid-v2_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| systemToken | String | 否 | 应用密钥。 ![[development-api-getformdatabyid-v2_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
