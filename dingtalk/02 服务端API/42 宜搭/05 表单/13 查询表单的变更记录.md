...
tags:
  ...
  - 服务端API
---
![[development-change-records-of-query-forms_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-change-records-of-query-forms_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09查询宜搭表单下的变更记录。

调用本接口，可以批量查询同一个应用、同一个表单（包括普通表单和流程表单）下多个实例的全部变更记录。变更记录内容包含：操作人、操作时间、操作字段、操作类型（新增、修改或删除）。

例如，调用本接口查询某表单的全部变更记录。如下图所示，当前表单的变更记录共3条，其中一条是某人在2022年4月8日11时38分4秒，把当前表单实例的数值从“2345”修改为“789”。

![[development-change-records-of-query-forms_O1CN01dHL0Fj1QxHW3OMeyT_!!6000000002042-2-tps-2210-1268.png]]
...
| 企业内部应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23ListOperationLogs) |
| 第三方企业应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23ListOperationLogs) |
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| formUuid | String | 是 | 表单编码。  **说明**  该参数从宜搭应用中获取。 ![[development-change-records-of-query-forms_O1CN01HdY3Dp1PuFLl6yIFS_!!6000000001900-2-tps-2688-1160.png]] |
| appType | String | 是 | 宜搭应用编码。  **说明**  该参数从宜搭应用中获取。 ![[development-change-records-of-query-forms_O1CN01fVFzAL1dFOZX3z8hV_!!6000000003706-2-tps-2390-854.png]] |
| systemToken | String | 是 | 宜搭应用密钥。  **说明**  该参数从宜搭应用中获取。 ![[development-change-records-of-query-forms_O1CN01dFq4Vj1Ti7FZf0zNz_!!6000000002415-2-tps-2382-862.png]] |
