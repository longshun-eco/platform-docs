...
tags:
  ...
  - 服务端API
---
![[development-depending-on-the-application-id-to-get-the-form-list_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-depending-on-the-application-id-to-get-the-form-list_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口，分页获取应用下的表单列表。

调用本接口，获取宜搭内某个应用下的表单列表，如下图所示。

![[development-depending-on-the-application-id-to-get-the-form-list_O1CN01Cunvdh1VWKKnOUrgC_!!6000000002660-2-tps-2768-1244.png]]

**说明**

目前只支持获取普通表单和流程表单。

![[development-depending-on-the-application-id-to-get-the-form-list_O1CN01doFiyW1G61LXtErUL_!!6000000000572-2-tps-2734-1060.png]]
...
| 企业内部应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23GetFormListInApp) |
| 第三方企业应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23GetFormListInApp) |
| 第三方个人应用 | 暂不支持 | 宜搭表单数据读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/yida/forms?appType=String&systemToken=String&formTypes=String&pageSize=Integer&pageNumber=Integer&userId=String HTTP/1.1
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| appType | String | 是 | 应用编码。 ![[development-depending-on-the-application-id-to-get-the-form-list_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| systemToken | String | 是 | 应用密钥，在应用数据中获取。 ![[development-depending-on-the-application-id-to-get-the-form-list_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
| formTypes | String | 否 | 表单类型。   * **receipt**：普通单据表单 * **process**：流程表单   **说明**   * 不传时两种表单均返回。 * 如需查询多种类型，可用英文逗号分隔。 |
