...
tags:
  ...
  - 服务端API
---
![[development-obtain-multiple-form-instance-data_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtain-multiple-form-instance-data_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09用于批量获取表单实例详情信息，包括实例名称、实例提交人等信息。

例如，企业宜搭应用数据管理中的宜搭实例列表如下截图，调用本接口，根据实例Id批量查询列表内实例的详情信息。

![[development-obtain-multiple-form-instance-data_O1CN01x46oHb1DM6MJ0kESH_!!6000000000201-2-tps-2322-1342.png]]
...
| 企业内部应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23BatchGetFormDataByIdList) |
| 第三方企业应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23BatchGetFormDataByIdList) |
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| formUuid | String | 是 | 宜搭表单编码。  **说明**  该参数从宜搭应用中查看。 ![[development-obtain-multiple-form-instance-data_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
| appType | String | 是 | 宜搭应用编码。  **说明**  该参数从宜搭应用中查看。 ![[development-obtain-multiple-form-instance-data_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
| systemToken | String | 是 | 宜搭应用密钥。  **说明**  该参数从宜搭应用中查看。 ![[development-obtain-multiple-form-instance-data_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
...
| sequence | String | 该表单实例对应的批量导入的批次号。  **说明**  如果是通过批量导入创建的实例，返回该字段。 |
