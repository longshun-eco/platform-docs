...
tags:
  ...
  - 服务端API
---
![[development-api-searchformdataidlist-v2_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-searchformdataidlist-v2_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口获取多个表单实例ID。
...
| 企业内部应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_2.0%23SearchFormDataIdList) |
| 第三方企业应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_2.0%23SearchFormDataIdList) |
| 第三方个人应用 | 暂不支持 | 宜搭表单数据读权限 | 暂不支持 |

## 请求方法

```
POST /v2.0/yida/forms/instances/ids/{appType}/{formUuid}?pageNumber=Integer&pageSize=Integer HTTP/1.1
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| appType | String | 是 | 应用编码。 ![[development-api-searchformdataidlist-v2_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| formUuid | String | 是 | 表单ID。 ![[development-api-searchformdataidlist-v2_O1CN01HdY3Dp1PuFLl6yIFS_!!6000000001900-2-tps-2688-1160.png]] |
...
| systemToken | String | 是 | 应用密钥。 ![[development-api-searchformdataidlist-v2_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
