...
tags:
  ...
  - 服务端API
---
![[development-get-form-field-information-based-on-form-uuid_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-get-form-field-information-based-on-form-uuid_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口，根据表单ID，获取单据或流程表单内的组件信息。

**说明**

本接口不支持宜搭2.0应用。

调用本接口，获取某个表单内的组件信息，如下图所示。

![[development-get-form-field-information-based-on-form-uuid_O1CN01uP9nUw1RUiTd1HDqR_!!6000000002115-2-tps-2718-1374.png]]
...
| 企业内部应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23GetFieldDefByUuid) |
| 第三方企业应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23GetFieldDefByUuid) |
| 第三方个人应用 | 暂不支持 | 宜搭表单数据读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/yida/forms/formFields?appType=String&systemToken=String&formUuid=String&userId=String HTTP/1.1
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| appType | String | 是 | 应用编码。 ![[development-get-form-field-information-based-on-form-uuid_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| systemToken | String | 是 | 应用密钥，在应用数据中获取。 ![[development-get-form-field-information-based-on-form-uuid_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
| formUuid | String | 是 | 表单唯一标识。   * 提供接口获取：调用[获取指定应用下的表单列表](/document/development/depending-on-the-application-id-to-get-the-form-list)接口获取formUuid参数值。 * 通过应用获取： ![[development-get-form-field-information-based-on-form-uuid_O1CN01HdY3Dp1PuFLl6yIFS_!!6000000001900-2-tps-2688-1160.png]] |
