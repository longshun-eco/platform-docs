...
tags:
  ...
  - 服务端API
---
![[development-delete-multiple-form-instances_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-delete-multiple-form-instances_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09用于批量删除表单实例数据，从表单实例列表中移除。

例如，企业宜搭应用数据管理中的实例列表如下图所示，列表内有四个宜搭表单实例，调用本接口删除第一个宜搭实例。

![[development-delete-multiple-form-instances_O1CN013uSmKe1emex4NXyjw_!!6000000003914-2-tps-2396-1408.png]]

调用成功后，宜搭应用数据管理中的实例只剩三个。

![[development-delete-multiple-form-instances_O1CN01qBwuXB1MSMJSnNhW1_!!6000000001433-2-tps-2404-1460.png]]
...
| 企业内部应用 | 支持 | 宜搭表单数据写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23BatchRemovalByFormInstanceIdList) |
| 第三方企业应用 | 支持 | 宜搭表单数据写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23BatchRemovalByFormInstanceIdList) |
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| formUuid | String | 是 | 表单编码。  **说明**  该参数从宜搭应用中获取。 ![[development-delete-multiple-form-instances_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
| appType | String | 是 | 宜搭应用编码。  **说明**  该参数从宜搭应用中获取。 ![[development-delete-multiple-form-instances_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
| asynchronousExecution | Boolean | 否 | 是否需要宜搭服务端异步执行该任务。   * true：允许。 * false：不允许。 |
| systemToken | String | 是 | 宜搭应用密钥。  **说明**  该参数从宜搭应用中获取。 ![[development-delete-multiple-form-instances_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
| formInstanceIdList | Array of String | 是 | 宜搭表单实例Id，调用[获取实例ID列表](/document/development/api-getinstanceidlist-v2)接口或者[获取多个表单实例ID](/document/development/api-searchformdataidlist-v2)接口获取。 |
| userId | String | 是 | 员工userId。 |
| executeExpression | Boolean | 否 | 是否需要触发表单绑定的校验规则、关联业务规则和第三方服务回调。   * true：需要。 * false：不需要   **说明**  该参数值传false可以降低API的耗时以及获得更大的单次删除数据量上限。 |
