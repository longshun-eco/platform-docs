...
tags:
  ...
  - 服务端API
---
![[development-api-createorupdateformdata-v2_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-createorupdateformdata-v2_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2026-03-16根据筛选条件筛选表单实例，满足筛选条件则根据指定表单值更新符合查询条件的表单实例，如果不存在满足筛选条件的表单实例，则根据指定表单值新增一条表单实例。

### 调用说明

企业宜搭应用的数据管理表单页面，如下图所示。

![[development-api-createorupdateformdata-v2_O1CN01xMec8D1uCVXeDmeNB_!!6000000006001-2-tps-1530-922.png]]
...
![[development-api-createorupdateformdata-v2_O1CN01qVNtmA1Ffuixq1kWM_!!6000000000515-2-tps-1536-916.png]]

* 不存在满足筛选条件的表单实例：

  **筛选条件：发起人是王某；表单状态为STRING；表单组件包含报销项目并指定该组件值为测试。**
  表单数据列表中已存在的四个表单：发起人都是张某，不存在王某发起的表单。

调用效果如下图所示，已新增一条以张某为发起人的表单实例。

![[development-api-createorupdateformdata-v2_O1CN01m1BxAA1EODoIjggKd_!!6000000000341-2-tps-1536-940.png]]
...
| --- | --- | --- | --- |
| 企业内部应用 | 支持 | 宜搭表单数据写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_2.0%23CreateOrUpdateFormData) |
| 第三方企业应用 | 支持 | 宜搭表单数据写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_2.0%23CreateOrUpdateFormData) |
...
| formUuid | String | 是 | 表单编码。  **说明**  该参数从宜搭应用中获取。 ![[development-api-createorupdateformdata-v2_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
| searchCondition | String | 是 | 用于检索表单实例数据的检索条件，格式参考[宜搭表单筛选的组件格式说明](https://open.dingtalk.com/document/development/use-the-filter-conditions-in-the-form-data-management-for)。 |
| appType | String | 是 | 宜搭应用编码。  **说明**  该参数从宜搭应用中获取。 ![[development-api-createorupdateformdata-v2_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
| formDataJson | String | 是 | 用于更新或新增表单实例的数据，格式参考[创建或更新表单数据格式说明](https://open.dingtalk.com/document/development/instructions-for-creating-or-updating-form-data-format)。 |
| systemToken | String | 是 | 宜搭应用密钥。  **说明**  该参数从宜搭应用中获取。 ![[development-api-createorupdateformdata-v2_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
