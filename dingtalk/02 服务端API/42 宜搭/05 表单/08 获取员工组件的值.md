...
tags:
  ...
  - 服务端API
---
![[development-gets-the-value-of-the-employee-component_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-gets-the-value-of-the-employee-component_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口获取员工组件的值。
...
| 企业内部应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23SearchEmployeeFieldValues) |
| 第三方企业应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23SearchEmployeeFieldValues) |
...
| formUuid | String | 否 | 表单ID。 ![[development-gets-the-value-of-the-employee-component_O1CN01HdY3Dp1PuFLl6yIFS_!!6000000001900-2-tps-2688-1160.png]] |
| appType | String | 否 | 应用ID。 ![[development-gets-the-value-of-the-employee-component_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| modifiedToTimeGMT | String | 否 | 修改时间终止值。 |
| systemToken | String | 否 | 应用密钥。 ![[development-gets-the-value-of-the-employee-component_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
