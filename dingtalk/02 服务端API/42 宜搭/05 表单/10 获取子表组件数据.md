...
tags:
  ...
  - 服务端API
---
![[development-obtain-child-table-component-data_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtain-child-table-component-data_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-23调用本接口通过表单实例ID和子表组ID获取子表组件数据。

![[development-obtain-child-table-component-data_O1CN01KSMHQI1GQd6TQXcUU_!!6000000000617-2-tps-1608-1226.png]]
...
| --- | --- | --- | --- |
| 企业内部应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23ListTableDataByFormInstanceIdTableId) |
| 第三方企业应用 | 支持 | 宜搭表单数据读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23ListTableDataByFormInstanceIdTableId) |
| 第三方个人应用 | 暂不支持 | 暂不支持 | 暂不支持 |

## 请求方法

```
GET /v1.0/yida/forms/innerTables/{formInstanceId}?formUuid=String&tableFieldId=String&pageNumber=Integer&pageSize=Integer&systemToken=String&userId=String HTTP/1.1
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| formInstanceId | String | 是 | 要查询的实例的实例ID，可通过[获取多个表单实例ID](https://open.dingtalk.com/document/development/api-searchformdataidlist-v2)接口获取。 |

## Query参数

| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| formUuid | String | 是 | 表单ID。 ![[development-obtain-child-table-component-data_O1CN01HdY3Dp1PuFLl6yIFS_!!6000000001900-2-tps-2688-1160.png]] |
| appType | String | 是 | 宜搭应用的唯一编码。  ![[development-obtain-child-table-component-data_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
| tableFieldId | String | 是 | 需要查找的子表单组件ID。 ![[development-obtain-child-table-component-data_O1CN01yTqqI51eViHNpsmb2_!!6000000003877-2-tps-2662-1014.png]] |
| pageNumber | Integer | 否 | 分页页码。 |
| pageSize | Integer | 否 | 分页大小。 |
| systemToken | String | 是 | 应用秘钥，在应用数据中获取。 ![[development-obtain-child-table-component-data_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
