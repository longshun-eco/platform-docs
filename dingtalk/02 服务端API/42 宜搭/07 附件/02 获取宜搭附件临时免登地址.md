...
tags:
  ...
  - 服务端API
---
![[development-obtain-the-temporary-free-access-address-of-yixian-accessories_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtain-the-temporary-free-access-address-of-yixian-accessories_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口获取宜搭附件临时免登地址。
...
| 企业内部应用 | 支持 | 宜搭附件读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=yida_1.0%23GetOpenUrl) |
| 第三方企业应用 | 支持 | 宜搭附件读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=yida_1.0%23GetOpenUrl) |
| 第三方个人应用 | 暂不支持 | 宜搭附件读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/yida/apps/temporaryUrls/{appType}?systemToken=String&userId=String&language=String&fileUrl=String&timeout=Long HTTP/1.1
