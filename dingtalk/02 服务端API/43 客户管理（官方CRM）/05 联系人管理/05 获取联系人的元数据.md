...
tags:
  ...
  - 服务端API
---
![[development-gets-the-metadata-description-of-a-crm-contact-object_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-gets-the-metadata-description-of-a-crm-contact-object_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-23调用本接口，获取钉钉CRM联系人的元数据描述。

调用本接口，可获取联系人的元数据，包括对象名称、字段名称、字段类型等。

![[development-gets-the-metadata-description-of-a-crm-contact-object_p372116.png]]
...
| 企业内部应用 | 是 | 获取CRM主数据的接口访问权限 | [调试](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=dingtalk.oapi.crm.objectmeta.contact.describe) |
| 第三方企业应用 | 是 | 获取CRM主数据的接口访问权限 | [调试](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=dingtalk.oapi.crm.objectmeta.contact.describe) |
| 第三方个人应用 | 否 | — | — |
...
**请求地址**：`https://oapi.dingtalk.com/topapi/crm/objectmeta/contact/describe`
...
```http
POST https://oapi.dingtalk.com/topapi/crm/objectmeta/contact/describe?access_token=ACCESS_TOKEN
```
