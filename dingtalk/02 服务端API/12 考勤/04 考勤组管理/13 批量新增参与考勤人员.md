...
tags:
  ...
  - 服务端API
---
![[development-batch-add-employees-under-the-attendance-group_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-batch-add-employees-under-the-attendance-group_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-10调用本接口根据考勤组groupKey，批量新增参与考勤人员到指定考勤组。

**说明**

调用接口添加参与考勤人员，只支持添加员工，不支持添加部门。

调用本接口，可在考勤组批量新增考勤人员。接口调用效果与下图操作实现效果一致。

![[development-batch-add-employees-under-the-attendance-group_p960302.png]]
...
| 企业内部应用 | 是 | 考勤组管理权限 | [调试](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=dingtalk.oapi.attendance.group.users.add) |
| 第三方企业应用 | 否 | — | — |
| 第三方个人应用 | 否 | — | — |
...
**请求地址**：`https://oapi.dingtalk.com/topapi/attendance/group/users/add`
...
| group\_key | String | 是 | CEDDxxxx | 考勤组ID。  **说明**  如果你使用的考勤组标识是group\_id，可以调用[groupId转换为groupKey](/document/development/groupid-to-groupkey)接口将group\_id转换为group\_key。 |
...
```http
POST https://oapi.dingtalk.com/topapi/attendance/group/users/add?access_token=ACCESS_TOKEN
```
