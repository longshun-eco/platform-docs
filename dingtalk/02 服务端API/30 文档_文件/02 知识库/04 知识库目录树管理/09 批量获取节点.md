...
tags:
  ...
  - 服务端API
---
![[development-obtain-nodes-in-batch_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtain-nodes-in-batch_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-12批量获取节点。

### 接口功能介绍

调用本接口，根据节点id和操作人unionId信息，批量查询节点信息。示例如下：

![[development-obtain-nodes-in-batch_节点列表.png]]
...
| 企业内部应用 | 支持 | 知识库节点读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=wiki_2.0%23GetNodes) |
| 第三方企业应用 | 支持 | 知识库节点读权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=wiki_2.0%23GetNodes) |
| 第三方个人应用 | 暂不支持 | 知识库节点读权限 | 暂不支持 |

## 请求方法

```
POST /v2.0/wiki/nodes/batchQuery?operatorId=String HTTP/1.1
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| nodeIds | Array of String | 是 | 节点id。  **说明**  最大size20。 |
