---
title: "配置企业钉工牌新版SDK"
source: "https://open.dingtalk.com/document/development/save-dingtalk-enterprise-instance"
category: "服务端API / 钉工牌"
updated: 
tags:
  - dingtalk
  - 服务端API
---
![[development-save-dingtalk-enterprise-instance_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-save-dingtalk-enterprise-instance_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-11调用本接口，为企业开通钉工牌电子码。

调用本接口，可用于为企业开通或关闭钉工牌电子码，并设置关联配置信息。
...
| 企业内部应用 | 支持 | 钉工牌基础数据写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=badge_1.0%23SaveBadgeCodeCorpInstance) |
| 第三方企业应用 | 支持 | 钉工牌基础数据写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=badge_1.0%23SaveBadgeCodeCorpInstance) |
| 第三方个人应用 | 暂不支持 | 钉工牌基础数据写权限 | 暂不支持 |

## 请求方法

```
POST /v1.0/badge/codes/corpInstances HTTP/1.1
...
| --- | --- | --- |
| 名称 | 类型 | 描述 |
| codeIdentity | String | 码标识。 |
| corpId | String | 开通的企业corpId。 |
| status | String | 状态，传入关闭状态需要用户手动开启后才会渲染二维码。   * **OPEN**：开启 * **CLOSED**：关闭 * **INVALID**：失效 |
