...
tags:
  ...
  - 服务端API
---
![[development-update-task-participants_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-update-task-participants_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口更新任务参与者。

### 接口功能介绍

调用本接口，根据操作者ID和任务ID，将用户ID添加到参与者，示例如下：

![[development-update-task-participants_任务参与者.png]]
...
| 企业内部应用 | 支持 | 项目应用任务写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=project_1.0%23UpdateTaskInvolvemembers) |
| 第三方企业应用 | 支持 | 项目应用任务写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=project_1.0%23UpdateTaskInvolvemembers) |
| 第三方个人应用 | 暂不支持 | 项目应用任务写权限 | 暂不支持 |

## 请求方法

```
PUT /v1.0/project/users/{userId}/tasks/{taskId}/involveMembers HTTP/1.1
