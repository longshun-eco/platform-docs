...
tags:
  ...
  - 服务端API
---
![[development-create-planned-work_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-create-planned-work_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-10-09调用本接口，新增项目任务中对应的计划工时。

### 接口调用说明

使用工时功能，需要先在项目中开启工时应用，具体步骤如下图所示。

![[development-create-planned-work_O1CN01Kx3K4S1BzpW4Q0f9i_!!6000000000017-2-tps-2740-1492.png]]

### 接口功能介绍

例如，员工小钉在9月23日的计划工时为4.5个小时，如下图所示。

![[development-create-planned-work_O1CN01MGr27Y1WqlblAFvhH_!!6000000002840-2-tps-2744-892.png]]

调用本接口，可以给小钉新增1小时计划工时。接口调用效果如下图所示，小钉在9月23日的计划工时为5.5个小时。

![[development-create-planned-work_O1CN01jg9IlJ22rk9ujqDas_!!6000000007174-2-tps-2746-816.png]]
...
| 企业内部应用 | 支持 | 项目应用任务写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=project_1.0%23CreatePlanTime) |
| 第三方企业应用 | 支持 | 项目应用任务写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=project_1.0%23CreatePlanTime) |
| 第三方个人应用 | 暂不支持 | 项目应用任务写权限 | 暂不支持 |

## 请求方法

```
POST /v1.0/project/users/{userId}/planTimes?tenantType=String HTTP/1.1
...
| planTime | Long | 是 | 计划工时时长，单位毫秒，1小时即为3600000。  **说明**  不超过24小时。 |
