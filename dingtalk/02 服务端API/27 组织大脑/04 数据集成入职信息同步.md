...
tags:
  ...
  - 服务端API
---
![[development-api-hrbrainimportregist_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-hrbrainimportregist_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-12调用本接口，入职信息同步至组织大脑，支持批量同步。
...
| 企业内部应用 | 支持 | 组织大脑数据集成写入权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=hrbrain_1.0%23HrbrainImportRegist) |
...
```
POST /v1.0/hrbrain/datas/registerInfos/import?corpId=String HTTP/1.1
