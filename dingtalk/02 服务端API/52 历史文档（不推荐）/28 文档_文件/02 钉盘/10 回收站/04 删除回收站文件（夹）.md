...
tags:
  ...
  - 服务端API
---
![[development-delete-recycle-bin-files-folders_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-delete-recycle-bin-files-folders_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口删除回收站文件或文件夹。

**重要**

为提升接口的使用体验，提供更加规范的接口，钉钉针对**钉盘**产品进行了升级，目前已升级为**存储**产品。本接口文档已于2023年01月17日迁移至**历史文档（不推荐）**目录下，且本接口仅保持现有功能，不再新增支持其他能力。

* 如果未使用本接口，推荐使用存储产品[删除回收项](/document/orgapp/delete-recycle-item)或者[批量删除回收项](/document/orgapp/batch-delete-recycle-items)接口。
* 如果已使用本接口，建议您根据自身实际情况切换至推荐接口。

调用本接口，实现删除回收站文件或文件夹，以删除回收站文件为例，具体示例如下图所示。

![[development-delete-recycle-bin-files-folders_O1CN01TH0mca1kqg5kNET9q_!!6000000004735-2-tps-325-645.png]]
