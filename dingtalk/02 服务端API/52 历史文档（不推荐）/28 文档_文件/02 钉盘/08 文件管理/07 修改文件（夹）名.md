...
tags:
  ...
  - 服务端API
---
![[development-modify-the-file-and-folder-name_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-modify-the-file-and-folder-name_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-12-08调用本接口修改文件（夹）名称。

**重要**

为提升接口的使用体验，提供更加规范的接口，钉钉针对**钉盘**产品进行了升级，目前已升级为**存储**产品。本接口文档已于2023年01月17日迁移至**历史文档（不推荐）**目录下，且本接口仅保持现有功能，不再新增支持其他能力。

* 如果未使用本接口，推荐使用存储产品[重命名文件或文件夹](/document/orgapp/rename-a-file-or-folder)接口。
* 如果已使用本接口，建议您根据自身实际情况切换至推荐接口。

调用本接口，实现修改文件（夹）名称，以修改文件名称为例，具体示例如下图所示。

![[development-modify-the-file-and-folder-name_O1CN012MhSdd1kaBpiTyh0V_!!6000000004699-2-tps-327-650.png]]
...
```
POST /v1.0/drive/spaces//files//rename HTTP/1.1
Host:api.dingtalk.com
