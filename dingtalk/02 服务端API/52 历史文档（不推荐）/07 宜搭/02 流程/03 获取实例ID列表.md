...
tags:
  ...
  - 服务端API
---
![[development-obtains-a-list-of-instance-ids_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtains-a-list-of-instance-ids_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获取实例ID列表。

**重要**

为提升接口使用体验，针对宜搭部分接口进行升级，本文档预计于 2024 年 11 月 1 日迁移至历史文档（不推荐）目录，接口不再支持新应用接入, 已接入的应用可继续调用，且本接口仅保持现有功能，不再新增支持其他能力。

* 如果未使用本接口，推荐使用[获取实例ID列表](/document/orgapp/api-getinstanceidlist-v2)接口。
* 如果已使用本接口，建议您根据自身实际情况评估是否切换至推荐接口。

![[development-obtains-a-list-of-instance-ids_O1CN010N2LDi1cEBtZLdKCY_!!6000000003568-2-tps-1008-512.png]]
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| formUuid | String | 是 | 表单ID。 ![[development-obtains-a-list-of-instance-ids_O1CN01HdY3Dp1PuFLl6yIFS_!!6000000001900-2-tps-2688-1160.png]] |
| modifiedToTimeGMT | String | 否 | 修改时间终止值。 |
| systemToken | String | 是 | 应用秘钥。 ![[development-obtains-a-list-of-instance-ids_O1CN01jA8xVe1ZStrN1fmGj_!!6000000003194-2-tps-2698-1144.png]] |
...
| appType | String | 是 | 应用编码。 ![[development-obtains-a-list-of-instance-ids_O1CN01auMafb1gfuQBoESlW_!!6000000004170-2-tps-2694-1114.png]] |
