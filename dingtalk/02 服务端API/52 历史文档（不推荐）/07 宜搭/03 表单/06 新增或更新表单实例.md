...
tags:
  ...
  - 服务端API
---
![[development-add-or-update-form-instances_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-add-or-update-form-instances_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08根据筛选条件筛选表单实例，满足筛选条件则根据指定表单值更新符合查询条件的表单实例，如果不存在满足筛选条件的表单实例，则根据指定表单值新增一条表单实例。

**重要**

为提升接口使用体验，针对宜搭部分接口进行升级，本文档预计于 2024 年 11 月 1 日迁移至历史文档（不推荐）目录，接口不再支持新应用接入, 已接入的应用可继续调用，且本接口仅保持现有功能，不再新增支持其他能力。

* 如果未使用本接口，推荐使用[新增或更新表单实例](/document/orgapp/api-createorupdateformdata-v2)接口。
...
![[development-add-or-update-form-instances_O1CN01xMec8D1uCVXeDmeNB_!!6000000006001-2-tps-1530-922.png]]
...
![[development-add-or-update-form-instances_O1CN01qVNtmA1Ffuixq1kWM_!!6000000000515-2-tps-1536-916.png]]
...
![[development-add-or-update-form-instances_O1CN01m1BxAA1EODoIjggKd_!!6000000000341-2-tps-1536-940.png]]
...
| formUuid | String | 是 | 表单编码。  **说明**  该参数从宜搭应用中获取。 ![[development-add-or-update-form-instances_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
...
| appType | String | 是 | 宜搭应用编码。  **说明**  该参数从宜搭应用中获取。 ![[development-add-or-update-form-instances_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
...
| systemToken | String | 是 | 宜搭应用密钥。  **说明**  该参数从宜搭应用中获取。 ![[development-add-or-update-form-instances_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
| userId | String | 是 | 用户userid。  **说明**  该用户userid对应的用户需拥有该表单所有的数据管理权限，否则可能会导致无法更新数据。 |
