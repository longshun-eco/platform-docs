...
tags:
  ...
  - 服务端API
---
![[development-query-form-instances-using-advanced-search-conditions_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-query-form-instances-using-advanced-search-conditions_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08使用筛选条件获取表单实例详情。

**重要**

为提升接口使用体验，针对宜搭部分接口进行升级，本文档预计于 2024 年 11 月 1 日迁移至历史文档（不推荐）目录，接口不再支持新应用接入, 已接入的应用可继续调用，且本接口仅保持现有功能，不再新增支持其他能力。

* 如果未使用本接口，推荐使用[通过高级查询条件获取表单实例数据（包括子表单组件数据）](/document/orgapp/api-searchformdatasecondgeneration-v2)接口。
...
![[development-query-form-instances-using-advanced-search-conditions_O1CN01NNaRYd1wyiSliMcuj_!!6000000006377-2-tps-1536-940.png]]
...
| formUuid | String | 是 | 表单编码。  **说明**  该参数从宜搭应用中获取。 ![[development-query-form-instances-using-advanced-search-conditions_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
...
| systemToken | String | 是 | 宜搭应用密钥。  **说明**  该参数从宜搭应用中获取。 ![[development-query-form-instances-using-advanced-search-conditions_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
| modifiedFromTimeGMT | String | 否 | 修改开始时间，格式yyyy-MM-dd HH:mm:ss。 |
| pageSize | Integer | 否 | 每页最大条目数，最大值100。 |
| userId | String | 是 | 用户userId。 |
| appType | String | 是 | 宜搭应用编码。  **说明**  该参数从宜搭应用中获取。 ![[development-query-form-instances-using-advanced-search-conditions_O1CN01JtSC2M20A7ARy6uY9_!!6000000006808-2-tps-2326-866.png]] |
...
| sequence | String | 此表单实例所对应的批量导入批次号。  **说明**  该表单实例是通过批量导入创建的，会返回该字段。 |
