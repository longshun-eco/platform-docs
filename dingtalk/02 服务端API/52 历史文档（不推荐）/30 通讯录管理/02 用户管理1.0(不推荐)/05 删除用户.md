...
tags:
  ...
  - 服务端API
---
![[development-delete-a-member_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-delete-a-member_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口删除指定用户。
...
| --- | --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| access\_token | String | 是 | 6ed1bxxx | 调用服务端API授权凭证，可通过[获取企业内部应用的access\_token](/document/orgapp/obtain-orgapp-token)接口获取。 |
| userid | String | 是 | user123 | 员工唯一标识userid，可通过[根据手机号查询用户](/document/orgapp/query-users-by-phone-number)接口获取userid。 |
