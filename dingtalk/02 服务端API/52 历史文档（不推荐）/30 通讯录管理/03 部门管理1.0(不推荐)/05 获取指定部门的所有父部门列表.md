...
tags:
  ...
  - 服务端API
---
![[development-queries-all-parent-departments-of-a-department_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-queries-all-parent-departments-of-a-department_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口查询指定部门的所有上级父部门路径。
...
| id | String | 否 | 420727358 | 部门ID，可通过调用[获取部门列表](/document/orgapp/obtain-the-department-list)接口获取。 |
