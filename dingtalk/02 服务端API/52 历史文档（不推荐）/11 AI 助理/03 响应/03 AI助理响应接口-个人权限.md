...
tags:
  ...
  - 服务端API
---
![[development-api-assistantmeresponse_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-assistantmeresponse_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2026-03-06调用本接口，通过个人权限token和助理相关参数，直接与助理直接对话，并获取大模型返回结果。
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| assistantId | String | 否 | 助理 ID，可调用[获取用户创建的AI助理列表](/document/development/assistant-acquires-list-assistants-created-by-users)接口获取助理 ID。 |
