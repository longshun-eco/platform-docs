...
tags:
  ...
  - 服务端API
---
![[development-message-description-service-desk_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-message-description-service-desk_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-12-08本文介绍了消息链接的打开方式。
...
* page表示小程序的页面地址, 例如pages/index/index, 这个page必须是app.json配置中pages下的路径。
  ...
  **说明**
  ...
  ![[development-message-description-service-desk_p158178.png]]
