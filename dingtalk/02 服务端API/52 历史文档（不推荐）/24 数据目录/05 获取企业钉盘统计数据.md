---
title: "获取企业钉盘统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/obtains-the-statistics-on-enterprise-dingtalk-trays"
...
tags:
  ...
  - 服务端API
---
![[development-obtains-the-statistics-on-enterprise-dingtalk-trays_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtains-the-statistics-on-enterprise-dingtalk-trays_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获取企业钉盘的统计数据。
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| 统计日期 | 组织ID | 钉盘用户数 | 钉盘上传文件数 | 钉盘预览文件数 |
| 20210101 | 12345 | 46 | 54 | 68 |
...
| 企业内部应用 | 支持 | 数据服务目录钉盘统计读权限 | **重要**  暂不支持新增申请。 |
| 第三方企业应用 | 暂不支持 | 数据服务目录钉盘统计读权限 | 暂不支持 |
| 第三方个人应用 | 暂不支持 | 数据服务目录钉盘统计读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/datacenter/driveData?statDate=String HTTP/1.1
...
```
GET /v1.0/datacenter/driveData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
...

{
  "metaList" : [ {
    ...
    "period" : "DAY",
    "kpiId" : "4117",
    "kpiCaliber" : "使用企业钉盘用户数",
    "kpiName" : "钉盘用户数"
  }, {
    "unit" : "",
    "period" : "DAY",
    "kpiId" : "4118",
    "kpiCaliber" : "企业钉盘中上传文件数量",
    "kpiName" : "钉盘上传文件数"
  }, {
    "unit" : "",
    "period" : "DAY",
    "kpiId" : "4119",
    "kpiCaliber" : "企业钉盘中被预览的文件数量",
```
