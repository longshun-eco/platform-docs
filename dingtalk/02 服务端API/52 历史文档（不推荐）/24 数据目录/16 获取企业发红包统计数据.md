---
title: "获取企业发红包统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/obtains-the-statistics-on-red-packets-issued-by-enterprises"
...
tags:
  ...
  - 服务端API
---
![[development-obtains-the-statistics-on-red-packets-issued-by-enterprises_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtains-the-statistics-on-red-packets-issued-by-enterprises_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获取企业发红包的统计数据。
...
|  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 统计日期 | 组织ID | 发送红包数 | 发送拼手气红包数 | 发送专享红包数 | 发送红包用户数 | 发送拼手气红包用户数 | 发送专享红包用户数 |
| 20210101 | 12345 | 15 | 14 | 1 | 14 | 14 | 1 |
...
| 企业内部应用 | 支持 | 数据服务目录红包统计读权限 | **重要**  暂不支持新增申请。 |
| 第三方企业应用 | 暂不支持 | 数据服务目录红包统计读权限 | 暂不支持 |
| 第三方个人应用 | 暂不支持 | 数据服务目录红包统计读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/datacenter/redEnvelopeSendData?statDate=String HTTP/1.1
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| x-acs-dingtalk-access-token | String | 是 | 调用该接口的访问凭证。   * 企业内部应用  调用[获取企业内部应用的accessToken](/document/orgapp-server/obtain-the-access_token-of-an-internal-app#topic-2056397)获取。 |
...
```
GET /v1.0/datacenter/redEnvelopeSendData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
