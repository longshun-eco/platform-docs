---
title: "获取企业用户在线统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/retrieve-online-statistics-of-enterprise-users"
...
tags:
  ...
  - 服务端API
---
![[development-retrieve-online-statistics-of-enterprise-users_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-retrieve-online-statistics-of-enterprise-users_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获取企业用户在线情况的统计数据。
...
|  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 统计日期 | 组织ID | 登录用户数 | 通讯录人数 | 登录在线人数 | 组织在线率 | 聊天用户数 | PC登录在线用户数 | APP登录在线用户数 |
| 20210101 | 12345 | 538 | 539 | 532 | 0.9871 | 500 | 529 | 421 |
...
| 企业内部应用 | 支持 | 数据服务目录通讯录统计读权限 | **重要**  暂不支持新增申请。 |
| 第三方企业应用 | 暂不支持 | 数据服务目录通讯录统计读权限 | 暂不支持 |
| 第三方个人应用 | 暂不支持 | 数据服务目录通讯录统计读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/datacenter/onlineUserData?statDate=String HTTP/1.1
...
```
GET /v1.0/datacenter/onlineUserData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
