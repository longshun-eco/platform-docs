---
title: "获取企业接收红包统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/queries-the-red-envelope-receiving-statistics-of-an-enterprise"
...
tags:
  ...
  - 服务端API
---
![[development-queries-the-red-envelope-receiving-statistics-of-an-enterprise_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-queries-the-red-envelope-receiving-statistics-of-an-enterprise_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获取企业接收红包（抢红包）的统计数据。
...
|  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 统计日期 | 组织ID | 接收红包数 | 接收拼手气红包数 | 接收专享红包数 | 接收红包用户数 | 接收拼手气红包用户数 | 接收专享红包用户数 |
| 20210101 | 12345 | 89 | 81 | 8 | 64 | 57 | 8 |
...
```
GET /v1.0/datacenter/redEnvelopeReciveData?statDate=String HTTP/1.1
...
```
GET /v1.0/datacenter/redEnvelopeReciveData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
...

{
  "metaList" : [ {
    ...
    "period" : "DAY",
    "kpiId" : "4069",
    "kpiCaliber" : "成功接收拼手气红包数量",
    "kpiName" : "接收拼手气红包数"
  }, {
    "unit" : "个",
    "period" : "DAY",
    "kpiId" : "4070",
    "kpiCaliber" : "成功接收给指定人的专享红包数量",
```
