---
title: "获取企业日志统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/obtain-enterprise-log-statistics"
...
tags:
  ...
  - 服务端API
---
![[development-obtain-enterprise-log-statistics_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtain-enterprise-log-statistics_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获取企业日志的统计数据。
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| 统计日期 | 组织ID | 发送日志数 | 发送日志用户数 | 评论日志用户数 |
| 20210101 | 12345 | 56 | 56 | 13 |
...
| 企业内部应用 | 支持 | 数据服务目录日志统计读权限 | **重要**  暂不支持新增申请。 |
...
```
GET /v1.0/datacenter/reportData?statDate=String HTTP/1.1
...
```
GET /v1.0/datacenter/reportData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
...

{
  "metaList" : [ {
    ...
    "period" : "DAY",
    "kpiId" : "4101",
    "kpiCaliber" : "发送钉钉日志用户数",
    "kpiName" : "发送日志用户数"
  }, {
    "unit" : "人",
    "period" : "DAY",
    "kpiId" : "4102",
    "kpiCaliber" : "评论钉钉日志用户数",
```
