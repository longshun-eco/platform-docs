---
title: "获取企业用户激活状态统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/obtains-statistics-on-user-activation-status"
...
tags:
  ...
  - 服务端API
---
![[development-obtains-statistics-on-user-activation-status_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtains-statistics-on-user-activation-status_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用接口获取企业用户激活状态的统计数据。
...
|  |  |  |  |
| --- | --- | --- | --- |
| 统计日期 | 组织ID | 累计激活人数 | 激活率 |
| 20210101 | 12345 | 538 | 0.7111 |
...
```
GET /v1.0/datacenter/activeUserData?statDate=String HTTP/1.1
...
```
GET /v1.0/datacenter/activeUserData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
...

{
  "metaList" : [ {
    ...
    "period" : "DAY",
    "kpiId" : "4007",
    "kpiCaliber" : "组织内截止当前，累计激活的用户数",
    "kpiName" : "累计激活人数"
  }, {
    "unit" : "",
    "period" : "DAY",
    "kpiId" : "4008",
    "kpiCaliber" : "激活用户数占比，累计激活人数/通讯录人数",
    "kpiName" : "激活率"
  } ],
  "dataList" : [ {
    "4008_DAY" : 0.9977011494252873,
    "4007_DAY" : 434,
    "stat_date" : "20210620",
```
