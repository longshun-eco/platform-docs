---
title: "获取企业钉钉运动统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/queries-dingtalk-movement-statistics"
...
tags:
  ...
  - 服务端API
---
![[development-queries-dingtalk-movement-statistics_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-queries-dingtalk-movement-statistics_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获取企业员工钉钉运动的统计数据。
...
|  |  |  |  |
| --- | --- | --- | --- |
| 统计日期 | 组织ID | 参与运动人数 | 超过5000步人数 |
| 20210101 | 12345 | 156 | 132 |
...
| 企业内部应用 | 支持 | 数据服务目录运动统计读权限 | **重要**  暂不支持新增申请。 |
| 第三方企业应用 | 暂不支持 | 数据服务目录运动统计读权限 | 暂不支持 |
| 第三方个人应用 | 暂不支持 | 数据服务目录运动统计读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/datacenter/healtheUserData?statDate=String HTTP/1.1
...
```
GET /v1.0/datacenter/healtheUserData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
...

{
  "metaList" : [ {
    ...
    "period" : "DAY",
    "kpiId" : "4082",
    "kpiCaliber" : "企业内参与运动人数",
    "kpiName" : "参与运动人数"
  }, {
    "unit" : "人",
    "period" : "DAY",
    "kpiId" : "4083",
    "kpiCaliber" : "企业内参与运动且步数超过5000步人数",
    "kpiName" : "超过5000步人数"
  } ],
  "dataList" : [ {
    "4083_DAY" : 12,
