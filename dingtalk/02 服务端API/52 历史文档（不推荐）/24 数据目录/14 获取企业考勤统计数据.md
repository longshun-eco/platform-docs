---
title: "获取企业考勤统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/queries-enterprise-attendance-statistics"
...
tags:
  ...
  - 服务端API
---
![[development-queries-enterprise-attendance-statistics_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-queries-enterprise-attendance-statistics_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获取企业考勤的统计数据。
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| 统计日期 | 组织ID | 应出勤人数 | 实际出勤人数 | 出勤率 |
| 20210101 | 12345 | 216 | 168 | 0.7778 |
...
| 企业内部应用 | 支持 | 数据服务目录考勤统计读权限 | **重要**  暂不支持新增申请。 |
| 第三方企业应用 | 暂不支持 | 数据服务目录考勤统计读权限 | 暂不支持 |
| 第三方个人应用 | 暂不支持 | 数据服务目录考勤统计读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/datacenter/attendanceData?statDate=String HTTP/1.1
...
```
GET /v1.0/datacenter/attendanceData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
...

{
  "metaList" : [ {
    ...
    "period" : "DAY",
    "kpiId" : "4084",
    "kpiCaliber" : "在考勤组内实际打卡人数",
    "kpiName" : "实际出勤人数"
  }, {
    "unit" : "人",
    "period" : "DAY",
    "kpiId" : "4085",
    "kpiCaliber" : "在考勤组内外勤打卡人数",
    "kpiName" : "外勤人数"
  }, {
    "unit" : "人",
    "period" : "DAY",
    "kpiId" : "4086",
    "kpiCaliber" : "在考勤组内应出勤人数",
```
