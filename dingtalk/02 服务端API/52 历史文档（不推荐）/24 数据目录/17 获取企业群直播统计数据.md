---
title: "获取企业群直播统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/obtains-the-live-stream-statistics-for-an-enterprise-group"
...
tags:
  ...
  - 服务端API
---
![[development-obtains-the-live-stream-statistics-for-an-enterprise-group_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtains-the-live-stream-statistics-for-an-enterprise-group_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获取企业群直播的统计数据。
...
|  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 统计日期 | 组织ID | 直播成功发起次数 | 直播观看次数 | 直播观看人数 | 直播时长（分钟） | 看直播人数 | 直播回看次数 | 直播回看人数 |
| 20210101 | 12345 | 8 | 550 | 426 | 248.5971 | 426 | 110 | 87 |
...
| 企业内部应用 | 支持 | 数据服务目录直播统计读权限 | **重要**  暂不支持新增申请。 |
| 第三方企业应用 | 暂不支持 | 数据服务目录直播统计读权限 | 暂不支持 |
| 第三方个人应用 | 暂不支持 | 数据服务目录直播统计读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/datacenter/groupLiveData?statDate=String HTTP/1.1
...
```
GET /v1.0/datacenter/groupLiveData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
