---
title: "获取企业文档统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/get-enterprise-document-statistics"
...
tags:
  ...
  - 服务端API
---
![[development-get-enterprise-document-statistics_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-get-enterprise-document-statistics_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08获取本接口获取企业文档的统计数据。
...
|  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| 统计日期 | 组织ID | 创建文档数 | 编辑文档数 | 分享文档数 | 阅读文档数 |
| 20210101 | 12345 | 11 | 13 | 17 | 28 |
...
| 企业内部应用 | 支持 | 数据服务目录文档统计读权限 | **重要**  暂不支持新增申请。 |
| 第三方企业应用 | 暂不支持 | 数据服务目录文档统计读权限 | 暂不支持 |
| 第三方个人应用 | 暂不支持 | 数据服务目录文档统计读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/datacenter/documentData?statDate=String HTTP/1.1
...
```
GET /v1.0/datacenter/documentData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
