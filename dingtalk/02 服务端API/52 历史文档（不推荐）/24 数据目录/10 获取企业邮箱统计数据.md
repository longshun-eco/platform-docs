---
title: "获取企业邮箱统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/queries-enterprise-email-statistics"
...
tags:
  ...
  - 服务端API
---
![[development-queries-enterprise-email-statistics_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-queries-enterprise-email-statistics_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获取企业邮箱的统计数据。
...
|  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 统计日期 | 组织ID | 钉邮操作次数 | 钉邮发送操作次数 | 钉邮转发操作次数 | 钉邮回复操作次数 | 钉邮发送操作用户数 | 钉邮转发操作用户数 | 钉邮回复操作用户数 |
| 20210101 | 12345 | 54 | 24 | 16 | 14 | 22 | 15 | 14 |
...
| 企业内部应用 | 支持 | 数据服务目录邮箱统计读权限 | **重要**  暂不支持新增申请。 |
| 第三方企业应用 | 暂不支持 | 数据服务目录邮箱统计读权限 | 暂不支持 |
| 第三方个人应用 | 暂不支持 | 数据服务目录邮箱统计读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/datacenter/mailData?statDate=String HTTP/1.1
...
```
GET /v1.0/datacenter/mailData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
...

{
  "metaList" : [ {
    ...
    "period" : "DAY",
    "kpiId" : "4110",
    "kpiCaliber" : "钉钉邮箱操作总次数",
    "kpiName" : "钉邮操作次数"
  }, {
    "unit" : "次",
    "period" : "DAY",
    "kpiId" : "4111",
    "kpiCaliber" : "钉钉邮箱中发送操作次数",
    "kpiName" : "钉邮发送操作次数"
  }, {
    "unit" : "次",
    "period" : "DAY",
    "kpiId" : "4112",
    "kpiCaliber" : "钉钉邮箱中转发操作次数",
```
