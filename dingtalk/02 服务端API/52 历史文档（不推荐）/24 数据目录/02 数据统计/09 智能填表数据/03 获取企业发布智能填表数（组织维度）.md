---
title: "获取企业发布智能填表数（组织维度）新版SDK"
source: "https://open.dingtalk.com/document/development/queries-the-number-of-tables-published-in-an-organization"
...
tags:
  ...
  - 服务端API
---
![[development-queries-the-number-of-tables-published-in-an-organization_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-queries-the-number-of-tables-published-in-an-organization_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口按组织维度获取企业发布智能填表数。
...
```
GET /v1.0/exclusive/data/generalForm/org/{dataId} HTTP/1.1
...
| --- | --- | --- |
| 名称 | 类型 | 描述 |
| generalFormCreatedCnt | String | 最近1天累计发布智能填表数。 |
...
```
GET /v1.0/exclusive/data/generalForm/org/20210801 HTTP/1.1
Host:api.dingtalk.com
