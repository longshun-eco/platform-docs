---
title: "获取发布智能填表数量和使用智能填表人数（部门维度）新版SDK"
source: "https://open.dingtalk.com/document/development/obtains-the-number-of-tables-published-by-the-enterprise-from"
...
tags:
  ...
  - 服务端API
---
![[development-obtains-the-number-of-tables-published-by-the-enterprise-from_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtains-the-number-of-tables-published-by-the-enterprise-from_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口按部门维度获取发布智能填表数量和使用智能填表人数。
...
```
GET /v1.0/exclusive/data/generalForm/dept/{dataId}?nextToken=Long&maxResults=Long HTTP/1.1
...
| generalFormCreateCnt1d | String | 最近1天累计发布智能填表数。 |
| useGeneralFormUserCnt1d | String | 最近1天使用智能填表人数。 |
...
```
GET /v1.0/exclusive/data/generalForm/dept/20210801?nextToken=0&maxResults=10 HTTP/1.1
Host:api.dingtalk.com
...

{
  "data" : [ {
    "deptId" : "123",
    "deptName" : "部门A",
    "generalFormCreateCnt1d" : "100",
    "useGeneralFormUserCnt1d" : "100"
  } ],
  "nextToken" : 2,
  "hasMore" : false
}
