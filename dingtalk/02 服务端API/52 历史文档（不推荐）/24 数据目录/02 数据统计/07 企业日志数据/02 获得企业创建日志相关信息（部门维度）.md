---
title: "获得企业创建日志相关信息（部门维度）新版SDK"
source: "https://open.dingtalk.com/document/development/obtains-information-about-a-created-enterprise-log-from-the-department"
...
tags:
  ...
  - 服务端API
---
![[development-obtains-information-about-a-created-enterprise-log-from-the-department_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtains-information-about-a-created-enterprise-log-from-the-department_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口按部门维度获取企业创建日志相关信息。
...
```
GET /v1.0/exclusive/data/report/dept/{dataId}?nextToken=Long&maxResults=Long HTTP/1.1
...
| --- | --- | --- |
| 名称 | 类型 | 描述 |
| data | Array | 部门维度发布日志信息。 |
| deptId | String | 部门ID。 |
| deptName | String | 部门名称。 |
| dingReportSendUsrCnt | String | 最近1天累计创建日志人数。 |
| dingReportSendCnt | String | 最近1天累计创建日志数。 |
...
```
GET /v1.0/exclusive/data/report/dept/20210801?nextToken=0&maxResults=10 HTTP/1.1
Host:api.dingtalk.com
...

{
  "data" : [ {
    "deptId" : "123",
    "deptName" : "部门A",
    "dingReportSendUsrCnt" : "100",
    "dingReportSendCnt" : "100"
  } ],
  "nextToken" : 2,
  "hasMore" : false
}
