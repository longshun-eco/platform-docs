---
title: "获取用户创建文档数和创建文档人数（组织维度）新版SDK"
source: "https://open.dingtalk.com/document/development/queries-the-number-dingtalk-documents-created-per-day-in-an"
...
tags:
  ...
  - 服务端API
---
![[development-queries-the-number-dingtalk-documents-created-per-day-in-an_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-queries-the-number-dingtalk-documents-created-per-day-in-an_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口按组织维度获取用户创建文档数和创建文档人数。
...
```
GET /v1.0/exclusive/data/doc/org/{dataId} HTTP/1.1
...
| --- | --- | --- |
| 名称 | 类型 | 描述 |
| docCreatedCnt | String | 最近1天累计创建文档数。 |
| docCreateUserCnt1d | String | 最近1天创建文档人数。 |
...
```
GET /v1.0/exclusive/data/doc/org/20210801 HTTP/1.1
Host:api.dingtalk.com
