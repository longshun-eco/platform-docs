---
title: "获得组织维度日程相关信息新版SDK"
source: "https://open.dingtalk.com/document/development/queries-the-number-of-people-who-have-created-an-event"
...
tags:
  ...
  - 服务端API
---
![[development-queries-the-number-of-people-who-have-created-an-event_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-queries-the-number-of-people-who-have-created-an-event_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获得组织维度日程相关信息。
...
```
GET /v1.0/exclusive/data/calendar/org/{dataId} HTTP/1.1
...
| --- | --- | --- |
| 名称 | 类型 | 描述 |
| calendarCreateUserCnt | String | 最近1天累计创建日程人数。 |
| useCalendarUserCnt1d | String | 最近1天使用日程人数。 |
| recvCalendarUserCnt1d | String | 最近1天接收日程人数。 |
...
```
GET /v1.0/exclusive/data/calendar/org/20210808 HTTP/1.1
Host:api.dingtalk.com
...
{
  "calendarCreateUserCnt" : "20",
  "useCalendarUserCnt1d" : "20",
  "recvCalendarUserCnt1d" : "20"
}
```
