---
title: "获取企业公告统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/queries-corporate-announcement-statistics"
...
tags:
  ...
  - 服务端API
---
![[development-queries-corporate-announcement-statistics_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-queries-corporate-announcement-statistics_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获取企业公告的统计数据。
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| 统计日期 | 组织ID | 公告已读人数 | 公告已接收人数 | 发布公告数 |
| 20210101 | 12345 | 81 | 80 | 1 |
...
| 企业内部应用 | 支持 | 数据服务目录公告统计读权限 | **重要**  暂不支持新增申请。 |
| 第三方企业应用 | 暂不支持 | 数据服务目录公告统计读权限 | 暂不支持 |
| 第三方个人应用 | 暂不支持 | 数据服务目录公告统计读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/datacenter/blackboardData?statDate=String HTTP/1.1
...
```
GET /v1.0/datacenter/blackboardData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
...

{
  "metaList" : [ {
    ...
    "period" : "DAY",
    "kpiId" : "4080",
    "kpiCaliber" : "企业内部群群公告已读人数",
    "kpiName" : "公告已读人数"
  }, {
    "unit" : "条",
    "period" : "DAY",
    "kpiId" : "5001",
    "kpiCaliber" : "新增发布群公告数量",
    "kpiName" : "发布公告数"
  }, {
    "unit" : "人",
    "period" : "DAY",
    "kpiId" : "5002",
    "kpiCaliber" : "已收到群公告的用户数。群公告发布后，群内所有用户计为已接收公告。",
```
