---
title: "获取企业审批统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/obtains-enterprise-approval-statistics"
...
tags:
  ...
  - 服务端API
---
![[development-obtains-enterprise-approval-statistics_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtains-enterprise-approval-statistics_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获取企业OA审批的统计数据。
...
|  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 统计日期 | 组织ID | 累计审批模板数 | 累计自定义审批模板数 | 新建自定义模板数 | 提交审批单数 | 提交审批用户数 | 活跃审批模板数 | 操作审批次数 | 操作审批用户数 |
| 20210101 | 12345 | 33 | 5 | 0 | 22 | 18 | 5 | 15 | 9 |
...
| 企业内部应用 | 支持 | 数据服务目录OA审批统计读权限 | **重要**  暂不支持新增申请。 |
| 第三方企业应用 | 暂不支持 | 数据服务目录OA审批统计读权限 | 暂不支持 |
| 第三方个人应用 | 暂不支持 | 数据服务目录OA审批统计读权限 | 暂不支持 |

## 请求方法

```
GET /v1.0/datacenter/approvalData?statDate=String HTTP/1.1
...
```
GET /v1.0/datacenter/approvalData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
...

{
  "metaList" : [ {
    ...
    "period" : "DAY",
    "kpiId" : "4092",
    "kpiCaliber" : "OA审批中累计审批模板数",
    "kpiName" : "累计审批模板数"
  }, {
    "unit" : "",
    "period" : "DAY",
    "kpiId" : "4093",
    "kpiCaliber" : "OA审批中累计自定审批模板数",
    "kpiName" : "累计自定义审批模板数"
  }, {
    "unit" : "",
    "period" : "DAY",
    "kpiId" : "4094",
    "kpiCaliber" : "OA审批中新建自定义模板数",
```
