---
title: "获取企业DING接收及评论统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/obtain-statistics-on-receiving-and-comments-of-enterprise-ding"
...
tags:
  ...
  - 服务端API
---
![[development-obtain-statistics-on-receiving-and-comments-of-enterprise-ding_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtain-statistics-on-receiving-and-comments-of-enterprise-ding_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获取企业接收和评论DING的统计数据。
...
|  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
| 统计日期 | 组织ID | 接收DING次数 | 接收应用DING次数 | 接收短信DING次数 | 接收电话DING次数 | DING评论数 |
| 20210101 | 12345 | 247 | 238 | 6 | 2 | 8 |
...
```
GET /v1.0/datacenter/dingReciveData?statDate=String HTTP/1.1
...
```
GET /v1.0/datacenter/dingReciveData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
...

{
  "metaList" : [ {
    ...
    "period" : "DAY",
    "kpiId" : "4044",
    "kpiCaliber" : "已接收DING次数",
    "kpiName" : "接收DING次数"
  }, {
    "unit" : "",
    "period" : "DAY",
    "kpiId" : "4045",
    "kpiCaliber" : "已接收应用类型DING次数",
    "kpiName" : "接收应用DING次数"
  }, {
    "unit" : "",
    "period" : "DAY",
    "kpiId" : "4046",
    "kpiCaliber" : "已接收短信类型DING次数",
```
