---
title: "获取企业电话会议统计数据新版SDK"
source: "https://open.dingtalk.com/document/development/get-enterprise-teleconference-statistics"
...
tags:
  ...
  - 服务端API
---
![[development-get-enterprise-teleconference-statistics_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-get-enterprise-teleconference-statistics_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-08调用本接口获取企业电话会议发起和参与情况的统计数据。
...
|  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
| 统计日期 | 组织ID | 电话会议发起次数 | 电话会议成功发起次数 | 电话会议发起用户数 | 电话会议成功参与人数 | 电话会议时长（分钟） |
| 20210101 | 12345 | 23 | 20 | 21 | 87 | 61.37 |
...
```
GET /v1.0/datacenter/telMeetingData?statDate=String HTTP/1.1
...
```
GET /v1.0/datacenter/telMeetingData?statDate=20210620 HTTP/1.1
Host:api.dingtalk.com
...

{
  "metaList" : [ {
    ...
    "period" : "DAY",
    "kpiId" : "4056",
    "kpiCaliber" : "发起并接通的电话会议次数",
    "kpiName" : "电话会议成功发起次数"
  }, {
    "unit" : "分钟",
    "period" : "DAY",
    "kpiId" : "4057",
    "kpiCaliber" : "发起并接通的电话会议总时长，单位分钟",
    "kpiName" : "电话会议时长"
  }, {
    "unit" : "人",
    "period" : "DAY",
    "kpiId" : "4058",
    "kpiCaliber" : "发起并接通的电话会议参与用户数",
```
