...
tags:
  ...
  - 服务端API
---
![[development-update-instance-status_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-update-instance-status_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-11调用本接口，更新OA审批实例状态。
...
![[development-update-instance-status_实例通过.jpg]]
...
| 企业内部应用 | 支持 | 工作流实例写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=workflow_1.0%23UpdateProcessInstance) |
| 第三方企业应用 | 支持 | 工作流实例写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=workflow_1.0%23UpdateProcessInstance) |
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| processInstanceId | String | 是 | 审批实例ID，调用[创建实例](/document/development/create-a-ticket-approval-instance)接口获取`processInstanceId`参数值。 |
