...
tags:
  ...
  - 服务端API
---
![[development-api-premiumgetnoticedinstances_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-premiumgetnoticedinstances_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-11调用本接口，可查询企业内指定用户已收到的实例列表（包含官方OA审批实例和三方业务系统同步到钉钉的外部集成审批实例），帮助企业自建审批中心。
...
调用本接口，可查询企业内指定用户已收到的实例列表（包含官方OA审批实例和三方业务系统同步到钉钉的外部集成审批实例），帮助企业自建审批中心。接口调用成功后，实现效果如下图所示。

![[development-api-premiumgetnoticedinstances_O1CN01DAVXg61f5toz67SlF_!!6000000003956-0-tps-2270-1168.jpg]]
...
| 企业内部应用 | 支持 | OA审批工作流读写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=workflow_1.0%23PremiumGetNoticedInstances) |
...
```
GET /v1.0/workflow/premium/processCentres/noticedInstances?userId=String&pageSize=Integer&pageNumber=Integer HTTP/1.1
