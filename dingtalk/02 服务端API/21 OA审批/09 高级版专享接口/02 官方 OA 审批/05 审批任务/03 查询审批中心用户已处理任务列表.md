...
tags:
  ...
  - 服务端API
---
![[development-api-premiumgetdonetasks_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-premiumgetdonetasks_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-11调用本接口，可查询企业内指定用户已处理的审批任务列表（包含官方OA审批任务和三方业务系统同步到钉钉的审批任务），帮助企业自建审批中心。
...
调用本接口，可查询企业内指定用户已处理的审批任务列表（包含官方OA审批任务和三方业务系统同步到钉钉的审批任务），帮助企业自建审批中心。接口调用成功后，实现效果如下图所示。

![[development-api-premiumgetdonetasks_O1CN01QLG9Fo1fjHsni0VSk_!!6000000004042-0-tps-2280-1000.jpg]]
...
| 企业内部应用 | 支持 | OA审批工作流读写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=workflow_1.0%23PremiumGetDoneTasks) |
...
```
GET /v1.0/workflow/premium/processCentres/doneTasks?userId=String&pageSize=Integer&pageNumber=Integer HTTP/1.1
