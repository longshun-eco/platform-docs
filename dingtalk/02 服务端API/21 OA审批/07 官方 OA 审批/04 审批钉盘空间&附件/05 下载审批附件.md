...
tags:
  ...
  - 服务端API
---
![[development-download-an-approval-attachment_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-download-an-approval-attachment_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-11调用本接口，获取审批文件下载授权，并且生成下载链接。
...
![[development-download-an-approval-attachment_p352488.png]]
...
| 企业内部应用 | 支持 | 工作流实例写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=workflow_1.0%23GrantProcessInstanceForDownloadFile) |
| 第三方企业应用 | 支持 | 工作流实例写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=workflow_1.0%23GrantProcessInstanceForDownloadFile) |
...
| fileId | String | 是 | 文件fileId，调用[获取单个审批实例详情](/document/development/obtains-the-details-of-a-single-approval-instance-pop)接口获取`fileId`参数值。  **说明**  文件id是审批组件中上传的fileId（如下图所示），评论中上传的附件fileId暂不支持获取下载链接。 ![[development-download-an-approval-attachment_p206204.png]] |
