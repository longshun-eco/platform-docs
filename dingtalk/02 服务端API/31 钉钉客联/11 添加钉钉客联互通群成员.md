...
tags:
  ...
  - 服务端API
---
![[development-add-a-group-member-1_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-add-a-group-member-1_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-24调用本接口，向互通群内添加群成员。
...
![[development-add-a-group-member-1_O1CN01O60xxA1MCmrs8bEBt_!!6000000001399-2-tps-2760-1214.png]]

调用本接口，可以向该群内添加名为**钉客通用户1**的钉外账号，接口调用成功后，效果如下图所示。

![[development-add-a-group-member-1_O1CN01GOTrzs1mWBeZVsuo6_!!6000000004961-2-tps-2764-1242.png]]
...
| appUserIds | Array of String | 否 | 钉外账号在业务系统内的唯一标志，调用[创建钉钉客联钉外账号](https://open.dingtalk.com/document/development/create-bc-account-association)接口获取，长度限制为1～64个字符，例如：1107\*\*\*\*2120。 |
| userIds | Array of String | 否 | 钉内账号userId，长度限制为1～64个字符，例如：1745\*\*\*\*8777。  **说明**  钉内账号和钉外账号总和不超过30个。 |
