...
tags:
  ...
  - 服务端API
---
![[development-api-updateguardian_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-updateguardian_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-23调用本接口，在指定的班级下更新学生家长信息。
...
| 企业内部应用 | 支持 | 钉钉教育家校通讯录写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=edu_1.0%23UpdateGuardian) |
| 第三方企业应用 | 支持 | 钉钉教育家校通讯录写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=edu_1.0%23UpdateGuardian) |
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| stuId | String | 是 | 学生ID，可调用[获取人员列表](/document/development/obtains-a-list-of-home-school-user-identities)接口获取userid参数值。 |
