...
tags:
  ...
  - 服务端API
---
![[development-obtain-the-relationship-between-home-and-school-personnel_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-obtain-the-relationship-between-home-and-school-personnel_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-23调用本接口，查看班级下某个监护人的详情。

调用本接口，获取学生监护人详情，包括班级ID、关系名、关系code、监护人userId等。

![[development-obtain-the-relationship-between-home-and-school-personnel_p526607.png]]
...
| 企业内部应用 | 是 | 钉钉教育家校通讯录读权限 | [调试](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=dingtalk.oapi.edu.user.relation.get) |
| 第三方企业应用 | 是 | 钉钉教育家校通讯录读权限 | [调试](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=dingtalk.oapi.edu.user.relation.get) |
| 第三方个人应用 | 否 | — | — |
...
**请求地址**：`https://oapi.dingtalk.com/topapi/edu/user/relation/get`
