...
tags:
  ...
  - 服务端API
---
![[development-add-course-participants_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-add-course-participants_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-23调用本接口，添加课程参与方。

调用本接口，可添加课程参与方。参与方角色包括学生、监护人和老师。

**重要**

授课老师只支持通过[创建课程](/document/development/create-course)和[修改课程](/document/development/modify-course)接口进行添加和修改。
...
| 企业内部应用 | 否 | — | — |
| 第三方企业应用 | 是 | 钉钉教育在线课堂数据写权限 | [调试](https://open-dev.dingtalk.com/apiExplorer#/?devType=isv&api=dingtalk.oapi.edu.course.participant.add) |
| 第三方个人应用 | 否 | — | — |
...
**请求地址**：`https://oapi.dingtalk.com/topapi/edu/course/participant/add`
...
| participant\_corpid | String | 是 | ding4220d8e5128d0edd | 参与方的组织cropId。 ![[development-add-course-participants_p526103.png]]  **重要**  **必须和当前组织相同或者存在关联关系。**  第三方企业应用请参考[关联关系](/document/development/associated-organizations-overview)。 |
...
```http
POST https://oapi.dingtalk.com/topapi/edu/course/participant/add?access_token=ACCESS_TOKEN
```
