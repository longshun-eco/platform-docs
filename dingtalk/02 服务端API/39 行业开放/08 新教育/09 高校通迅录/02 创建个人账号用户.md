---
title: "创建个人账号用户新版SDK"
source: "https://open.dingtalk.com/document/development/api-addcollegecontactuser"
...
tags:
  ...
  - 服务端API
---
![[development-api-addcollegecontactuser_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-api-addcollegecontactuser_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]

更新于 2025-09-23调用本接口创建新的个人账号用户。创建高校账号用户请使用另外一个创建高校账号用户接口
...
| 企业内部应用 | 支持 | 钉钉教育高校通讯录写权限 | [API Explorer](https://open-dev.dingtalk.com/apiExplorer#/?devType=org&api=edu_1.0%23AddCollegeContactUser) |
...
```
POST /v1.0/edu/collegeContact/personalAccounts/users HTTP/1.1
...
| mobile | String | 是 | 手机号码，企业内必须唯一，不可重复。  目前仅限国内手机号码，国外手机号不可使用 |
