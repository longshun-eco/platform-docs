...
tags:
  ...
  - 事件订阅
---
![[development-group-session-delete-persons_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-group-session-delete-persons_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| eventType | String | chat\_remove\_member | 事件类型。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| EventType | String | chat\_remove\_member | 事件英文名称。 |
...
| biz\_type | Integer | 178 | 事件bizType。 |
