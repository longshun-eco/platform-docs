...
tags:
  ...
  - 事件订阅
---
![[development-attendance-day-statistics-change-event_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-attendance-day-statistics-change-event_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| eventType | String | attend\_user\_daily\_summary\_refresh | 事件类型。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| EventType | String | attend\_user\_daily\_summary\_refresh | 事件英文名称。 |
| EventTime | Long | 1663143335567 | 事件发生的时间。 |
| CorpId | String | ding9f50b15bxxxx16741 | 企业corpId。 |
| BizId | String | 1663\*\*35567 | 无业务意义，幂等。 |
| eventId | String | c7c7120f2c07419\*\*ebdba0318c8 | 事件的唯一Id。 |
| workDate | String | 2023-12-12 | 工作日。 |
| userId | String | 1234 | 员工id。 |
...
| biz\_type | Integer | 354 | 事件bizType。 |
