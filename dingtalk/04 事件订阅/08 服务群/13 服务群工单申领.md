...
tags:
  ...
  - 事件订阅
---
![[development-service-group-work-order-application_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-service-group-work-order-application_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| eventType | String | servicegroup\_ticket\_take | 事件类型。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| EventType | String | servicegroup\_ticket\_take | 事件英文名称。 |
...
| biz\_type | Integer | 116 | 事件bizType。 |
