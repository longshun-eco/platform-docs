...
tags:
  ...
  - 事件订阅
---
![[development-event-doc-spaces-create-team_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-event-doc-spaces-create-team_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| eventType | String | doc\_spaces\_create\_team | 事件类型。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| EventType | String | doc\_spaces\_create\_team | 事件英文名称。 |
...
| teamId | String | YRB\*\*\*\*4Jm | 创建的小组id。 |
| type | String | TEAM\_CREATE | 类型：   * TEAM\_CREATE：创建小组 |
