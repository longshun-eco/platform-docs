...
tags:
  ...
  - 事件订阅
---
![[development-event-storage-dentry-update_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-event-storage-dentry-update_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| eventType | String | storage\_dentry\_update | 事件类型。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| EventType | String | storage\_dentry\_update | 事件英文名称。 |
| EventTime | Long | 1663143335567 | 事件发生的时间。 |
| CorpId | String | ding9f50b15bxxxx16741 | 企业corpId。 |
| BizId | String | 1663\*\*35567 | 无业务意义，幂等。 |
| eventId | String | c7c7120f2c07419\*\*ebdba0318c8 | 事件的唯一Id。 |
| spaceId | String | xxx | 空间Id。 |
| dentryId | String | xxx | 文件Id。 |
| eventScope | String | ORG | 订阅范围 ：   * ORG: 企业 * SPACE: 空间 |
| extension | String | pdf | 后缀信息。 |
| unionId | String | xx | 操作人unionId。 |
| eventScopeId | String | xx | 订阅ID：   * 当eventScope为ORG时，对应当前企业corpId。 * 当eventScope为SPACE时，对应空间id。 |
...
| biz\_type | Integer | 234 | 事件bizType。 |
