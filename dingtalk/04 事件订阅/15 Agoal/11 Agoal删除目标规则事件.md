...
tags:
  ...
  - 事件订阅
---
![[development-events-agoal-objectiverule-remove_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-events-agoal-objectiverule-remove_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| eventType | String | agoal\_objectiveRule\_remove | 事件类型。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| EventType | String | agoal\_objectiveRule\_remove | 事件英文名称。 |
...
| biz\_type | Integer | 460 | 事件bizType。 |
