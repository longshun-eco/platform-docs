...
tags:
  ...
  - 事件订阅
---
![[development-events-agoal-indicator-modify_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-events-agoal-indicator-modify_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| --- | --- |
| 中文名称 | Agoal修改指标事件 |
| 英文名称 | agoal\_indicator\_modify |

## 功能描述

Agoal修改指标事件：当Agoal管理员在Agoal中修改指标内容时，会发送事件通知订阅方被修改指标的信息，主要是用来给三方合作伙伴使用，合作伙伴接收事件以同步被修改指标相关信息。
...
| eventType | String | agoal\_indicator\_modify | 事件类型。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| EventType | String | agoal\_indicator\_modify | 事件英文名称。 |
...
| biz\_type | Integer | 451 | 事件bizType。 |
...
```json
{
  ...
  "biz_data": {
    ...
    "syncAction": "agoal_indicator_modify",
