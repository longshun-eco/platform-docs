...
tags:
  ...
  - 事件订阅
---
![[development-enterprise-self-built-application-status-change_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-enterprise-self-built-application-status-change_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| eventType | String | inner\_app\_status\_change | 事件类型。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| EventType | String | inner\_app\_status\_change | 事件英文名称。 |
...
| status | String | disable | 事件当前状态：   * disable：停用 * enable：启用 * delete：删除 |
