...
tags:
  ...
  - 事件订阅
---
![[development-new-education-staff-relationship-update_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-new-education-staff-relationship-update_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| eventType | String | edu\_user\_relation\_update | 事件类型。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| EventType | String | edu\_user\_relation\_update | 事件英文名称。 |
...
| relationName | String | 妈妈 | 关系名。 |
| fromUserid | String | 34567890 | 用户id。 |
| relationCode | String | M | 关系code。 |
| toUserid | String | 34567890 | 用户id。 |
