...
tags:
  ...
  - 事件订阅
---
![[development-education-department-delete_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-education-department-delete_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| EventType | String | edu\_dept\_delete | 事件英文名称。 |
...
| dept\_id | Long | 12345 | 部门节点ID。 |
| is\_graduate | Integer | 0 | * 0：表示正常的删除。 * 1：表示毕业。 |
