...
tags:
  ...
  - 事件订阅
---
![[development-asynchronous-translation-address-book-stream_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-asynchronous-translation-address-book-stream_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| eventType | String | transfer\_contact\_id\_job\_result | 事件类型。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| jobId | String | seejaRmXY8RQgo2SJSHS92xxxxxxx | 任务ID。 |
| status | String | 1 | 任务状态。 |
