...
tags:
  ...
  - 事件订阅
---
![[development-events-flash-minutes-open-event-directed_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-events-flash-minutes-open-event-directed_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| eventType | String | flash\_minutes\_open\_event\_directed | 事件类型。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| EventType | String | flash\_minutes\_open\_event\_directed | 事件英文名称。 |
...
| minutesTaskId | Number | 115\*\*\*\*09 | 闪记taskId。  请依据conferenceId作为闪记状态依据。 |
...
| biz\_type | Integer | 400 | 事件bizType。 |
