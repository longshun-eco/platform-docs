...
tags:
  ...
  - 事件订阅
---
![[development-asr-transcription-conferences-targeted-event-push_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-asr-transcription-conferences-targeted-event-push_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| eventType | String | meeting\_asr\_result\_event\_directed | 事件类型。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| EventType | String | meeting\_asr\_result\_event\_directed | 事件英文名称。 |
...
| header | Object |  | 转写结果头。 |
| timestamp | Long | 1733716797727 | 事件回调时间戳。 |
| bizType | String | minutes : 闪记 cloud\_record : 云录制 | 转写事件对应，业务类型。 |
| recordId | String | 1232141245 | 转写事件对应业务id。 |
...
| biz\_type | Integer | 412 | 事件bizType。 |
