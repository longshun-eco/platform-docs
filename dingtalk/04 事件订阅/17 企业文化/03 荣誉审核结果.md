...
tags:
  ...
  - 事件订阅
---
![[development-honor-review-results_O1CN01Zx4PED22rkUkmRe1L_!!6000000007174-2-tps-226-40.png]]![[development-honor-review-results_O1CN01UwOv1C27lrTuGFj2D_!!6000000007838-2-tps-17-30.png]]
...
| eventType | String | honor\_audit | 事件类型。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| EventType | String | honor\_audit | 事件英文名称。 |
| EventTime | Long | 1663143335567 | 事件发生的时间。 |
| CorpId | String | ding9f50b15bxxxx16741 | 企业corpId。 |
| BizId | String | 1663\*\*35567 | 无业务意义，幂等。 |
| eventId | String | c7c7120f2c07419\*\*ebdba0318c8 | 事件的唯一Id。 |
| honorId | String | 216\*\*\*02 | 荣誉勋章模板id。 |
| auditStatus | Boolean | false | 审核结果：   * true：审核通过 * false：审核拒绝 |
| remark | String | 文案中包含敏感词，请查看《钉钉荣誉规范条款》 | 审核拒绝原因。  当auditStatus为false时，该字段有值。 |
...
| biz\_type | Integer | 270 | 事件bizType。 |
